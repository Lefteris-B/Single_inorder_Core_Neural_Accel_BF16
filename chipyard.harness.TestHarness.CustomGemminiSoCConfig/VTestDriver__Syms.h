...
class VTestDriver__Syms final : public VerilatedSyms {
  public:
    ...
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__subsystem_l2_wrapper__l2__inclusive_cache_bank_sched__abc_mshrs_5;
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__subsystem_l2_wrapper__l2__inclusive_cache_bank_sched__abc_mshrs_6;
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__subsystem_l2_wrapper__l2__inclusive_cache_bank_sched__abc_mshrs_7;
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__subsystem_l2_wrapper__l2__inclusive_cache_bank_sched__abc_mshrs_8;
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__subsystem_l2_wrapper__l2__inclusive_cache_bank_sched__abc_mshrs_9;
    ...
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__subsystem_sbus__coupler_from_bus_named_subsystem_fbus__widget__monitor;
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__subsystem_sbus__coupler_to_bus_named_subsystem_cbus__widget__monitor;
    ...
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__tile_prci_domain__buffer__monitor_1;
    ...
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__tile_prci_domain__tile_reset_domain_tile__dcIF;
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__tile_prci_domain__tile_reset_domain_tile__dcIF__replayq;
    ...
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__tile_prci_domain__tile_reset_domain_tile__gemmini;
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__tile_prci_domain__tile_reset_domain_tile__gemmini__ex_controller;
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__tile_prci_domain__tile_reset_domain_tile__gemmini__ex_controller__cmd_q;
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__tile_prci_domain__tile_reset_domain_tile__gemmini__ex_controller__mesh;
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__tile_prci_domain__tile_reset_domain_tile__gemmini__ex_controller__mesh__tagq;
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__tile_prci_domain__tile_reset_domain_tile__gemmini__ex_controller__unrolled_cmd_mod__q;
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__tile_prci_domain__tile_reset_domain_tile__gemmini__load_controller;
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__tile_prci_domain__tile_reset_domain_tile__gemmini__load_controller__cmd_tracker;
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__tile_prci_domain__tile_reset_domain_tile__gemmini__load_controller__cmd_tracker__assert___05Fassert;
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__tile_prci_domain__tile_reset_domain_tile__gemmini__mod;
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__tile_prci_domain__tile_reset_domain_tile__gemmini__mod_1;
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__tile_prci_domain__tile_reset_domain_tile__gemmini__mod_1__ex;
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__tile_prci_domain__tile_reset_domain_tile__gemmini__mod_1__ldab_arb;
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__tile_prci_domain__tile_reset_domain_tile__gemmini__reservation_station;
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__tile_prci_domain__tile_reset_domain_tile__gemmini__reservation_station__assert___05Fassert_6;
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__tile_prci_domain__tile_reset_domain_tile__gemmini__reservation_station__assert___05Fassert_7;
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__tile_prci_domain__tile_reset_domain_tile__gemmini__reservation_station__assert___05Fassert_8;
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__tile_prci_domain__tile_reset_domain_tile__gemmini__spad;
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__tile_prci_domain__tile_reset_domain_tile__gemmini__spad__acc_mems_0;
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__tile_prci_domain__tile_reset_domain_tile__gemmini__spad__acc_mems_1;
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__tile_prci_domain__tile_reset_domain_tile__gemmini__spad__buffer_1__monitor;
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__tile_prci_domain__tile_reset_domain_tile__gemmini__spad__buffer_2__monitor;
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__tile_prci_domain__tile_reset_domain_tile__gemmini__spad__buffer__monitor;
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__tile_prci_domain__tile_reset_domain_tile__gemmini__spad__mvin_scale_pixel_repeater;
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__tile_prci_domain__tile_reset_domain_tile__gemmini__spad__reader__xactTracker;
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__tile_prci_domain__tile_reset_domain_tile__gemmini__spad__reader__xactTracker__assert___05Fassert;
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__tile_prci_domain__tile_reset_domain_tile__gemmini__spad__spad_mems_0;
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__tile_prci_domain__tile_reset_domain_tile__gemmini__spad__spad_mems_1;
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__tile_prci_domain__tile_reset_domain_tile__gemmini__spad__spad_mems_2;
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__tile_prci_domain__tile_reset_domain_tile__gemmini__spad__spad_mems_3;
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__tile_prci_domain__tile_reset_domain_tile__gemmini__spad__writer;
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__tile_prci_domain__tile_reset_domain_tile__gemmini__spad__xbar;
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__tile_prci_domain__tile_reset_domain_tile__gemmini__spad__xbar__monitor;
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__tile_prci_domain__tile_reset_domain_tile__gemmini__spad__xbar__monitor_1;
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__tile_prci_domain__tile_reset_domain_tile__gemmini__spad__zero_writer_pixel_repeater;
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__tile_prci_domain__tile_reset_domain_tile__gemmini__store_controller;
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__tile_prci_domain__tile_reset_domain_tile__gemmini__store_controller__cmd_tracker;
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__tile_prci_domain__tile_reset_domain_tile__gemmini__store_controller__cmd_tracker__assert___05Fassert;
    VerilatedScope __Vscope_TestDriver__testHarness__chiptop0__system__tile_prci_domain__tile_reset_domain_tile__gemmini__tlb__tlbs_0;

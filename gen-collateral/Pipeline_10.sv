...
module Pipeline_10(
  ...
  input  [33:0] io_in_bits_dram_addr,
  ...
  output [63:0] io_out_bits_cmd_rs1,
                io_out_bits_cmd_rs2,
  output [33:0] io_out_bits_dram_addr,
  ...
  reg  [33:0] stages_0_dram_addr;	// @[Pipeline.scala:21:21]
  ...
  reg  [33:0] stages_1_dram_addr;	// @[Pipeline.scala:21:21]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        stages_0_dram_addr = {_RANDOM_8[31:9], _RANDOM_9[10:0]};	// @[Pipeline.scala:21:21]
        stages_0_spad_addr = {_RANDOM_9[31:11], _RANDOM_10, _RANDOM_11[14:0]};	// @[Pipeline.scala:21:21]
        stages_0_I = _RANDOM_11[30:15];	// @[Pipeline.scala:21:21]
        stages_0_J = {_RANDOM_11[31], _RANDOM_12[14:0]};	// @[Pipeline.scala:21:21]
        stages_1_cmd_inst_funct = _RANDOM_12[21:15];	// @[Pipeline.scala:21:21]
        stages_1_cmd_inst_rs2 = _RANDOM_12[26:22];	// @[Pipeline.scala:21:21]
        stages_1_cmd_inst_rs1 = _RANDOM_12[31:27];	// @[Pipeline.scala:21:21]
        stages_1_cmd_inst_xd = _RANDOM_13[0];	// @[Pipeline.scala:21:21]
        stages_1_cmd_inst_xs1 = _RANDOM_13[1];	// @[Pipeline.scala:21:21]
        stages_1_cmd_inst_xs2 = _RANDOM_13[2];	// @[Pipeline.scala:21:21]
        stages_1_cmd_inst_rd = _RANDOM_13[7:3];	// @[Pipeline.scala:21:21]
        stages_1_cmd_inst_opcode = _RANDOM_13[14:8];	// @[Pipeline.scala:21:21]
        stages_1_cmd_rs1 = {_RANDOM_13[31:15], _RANDOM_14, _RANDOM_15[14:0]};	// @[Pipeline.scala:21:21]
        stages_1_cmd_rs2 = {_RANDOM_15[31:15], _RANDOM_16, _RANDOM_17[14:0]};	// @[Pipeline.scala:21:21]
        stages_1_dram_addr = {_RANDOM_20[31:24], _RANDOM_21[25:0]};	// @[Pipeline.scala:21:21]
        stages_1_spad_addr = {_RANDOM_21[31:26], _RANDOM_22, _RANDOM_23[29:0]};	// @[Pipeline.scala:21:21]
        stages_1_I = {_RANDOM_23[31:30], _RANDOM_24[13:0]};	// @[Pipeline.scala:21:21]
        stages_1_J = _RANDOM_24[29:14];	// @[Pipeline.scala:21:21]
        valids_0 = _RANDOM_24[30];	// @[Pipeline.scala:21:21, :22:25]
        valids_1 = _RANDOM_24[31];	// @[Pipeline.scala:21:21, :22:25]
      `endif // RANDOMIZE_REG_INIT
    end // initial

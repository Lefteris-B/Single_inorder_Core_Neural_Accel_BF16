...
module TLMonitor_21(
  ...
  `ifndef SYNTHESIS
    ...
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_9 & ~reset & ~(_T_536 & (io_in_a_bits_source[6:4] == 3'h2 | io_in_a_bits_source[6:4] == 3'h1 | ~(|(io_in_a_bits_source[6:4])) | _WIRE_2_3 | _source_ok_WIRE_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6))) begin	// @[Misc.scala:201:81, Monitor.scala:42:11, :104:45, :640:42, Parameters.scala:46:9, :54:{10,32}, :92:42, :1161:30, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]

...
module TLMonitor_24(
  ...
  `ifndef SYNTHESIS
    ...
    wire             _WIRE_2_3 = io_in_a_bits_source == 7'h30;	// @[Parameters.scala:46:9]
    wire             _source_ok_WIRE_4 = io_in_a_bits_source == 7'h31;	// @[Parameters.scala:46:9]
    wire             _source_ok_WIRE_5 = io_in_a_bits_source == 7'h32;	// @[Parameters.scala:46:9]
    wire             _source_ok_WIRE_6 = io_in_a_bits_source == 7'h40;	// @[Parameters.scala:46:9]
    wire             source_ok = io_in_a_bits_source[6:4] == 3'h2 | io_in_a_bits_source[6:4] == 3'h1 | ~(|(io_in_a_bits_source[6:4])) | _WIRE_2_3 | _source_ok_WIRE_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6;	// @[Misc.scala:201:81, Monitor.scala:640:42, Parameters.scala:46:9, :54:{10,32}, :1126:46]
    ...
    wire             source_ok_1 = io_in_d_bits_source[6:4] == 3'h2 | io_in_d_bits_source[6:4] == 3'h1 | io_in_d_bits_source[6:4] == 3'h0 | io_in_d_bits_source == 7'h30 | io_in_d_bits_source == 7'h31 | io_in_d_bits_source == 7'h32 | io_in_d_bits_source == 7'h40;	// @[Misc.scala:201:{34,81}, Monitor.scala:640:42, Parameters.scala:46:9, :54:{10,32}, :1126:46]
    ...
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_9 & ~reset & ~(_T_368 & (io_in_a_bits_source[6:4] == 3'h2 | io_in_a_bits_source[6:4] == 3'h1 | ~(|(io_in_a_bits_source[6:4])) | _WIRE_2_3 | _source_ok_WIRE_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6))) begin	// @[Misc.scala:201:81, Monitor.scala:42:11, :104:45, :640:42, Parameters.scala:46:9, :54:{10,32}, :92:42, :1161:30, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_9 & ~reset & ~(_T_368 & (&(io_in_a_bits_address[13:12])))) begin	// @[Monitor.scala:42:11, :104:45, Parameters.scala:92:42, :137:65, :671:54]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_11 & ~reset & ~(io_in_a_bits_size < 4'hD & (io_in_a_bits_source[6:4] == 3'h2 | io_in_a_bits_source[6:4] == 3'h1 | ~(|(io_in_a_bits_source[6:4])) | _WIRE_2_3 | _source_ok_WIRE_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6) & (&(io_in_a_bits_address[13:12])))) begin	// @[Misc.scala:201:81, Monitor.scala:42:11, :114:53, :115:71, :640:42, Parameters.scala:46:9, :54:{10,32}, :92:42, :137:65, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_12 & ~reset & ~(io_in_a_bits_size < 4'hD & (io_in_a_bits_source[6:4] == 3'h2 | io_in_a_bits_source[6:4] == 3'h1 | ~(|(io_in_a_bits_source[6:4])) | _WIRE_2_3 | _source_ok_WIRE_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6) & (&(io_in_a_bits_address[13:12])))) begin	// @[Misc.scala:201:81, Monitor.scala:42:11, :122:56, :123:74, :640:42, Parameters.scala:46:9, :54:{10,32}, :92:42, :137:65, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_13 & ~reset & ~(io_in_a_bits_size < 4'hD & (io_in_a_bits_source[6:4] == 3'h2 | io_in_a_bits_source[6:4] == 3'h1 | ~(|(io_in_a_bits_source[6:4])) | _WIRE_2_3 | _source_ok_WIRE_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6) & io_in_a_bits_size < 4'h4 & (&(io_in_a_bits_address[13:12])))) begin	// @[Misc.scala:201:81, Monitor.scala:42:11, :130:56, :131:74, :640:42, Parameters.scala:46:9, :54:{10,32}, :92:42, :137:65, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_14 & ~reset & ~(io_in_a_bits_size < 4'hD & (io_in_a_bits_source[6:4] == 3'h2 | io_in_a_bits_source[6:4] == 3'h1 | ~(|(io_in_a_bits_source[6:4])) | _WIRE_2_3 | _source_ok_WIRE_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6) & io_in_a_bits_size < 4'h4 & (&(io_in_a_bits_address[13:12])))) begin	// @[Misc.scala:201:81, Monitor.scala:42:11, :138:53, :139:71, :640:42, Parameters.scala:46:9, :54:{10,32}, :92:42, :137:65, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_15 & ~reset & ~(io_in_a_bits_size < 4'hD & (io_in_a_bits_source[6:4] == 3'h2 | io_in_a_bits_source[6:4] == 3'h1 | ~(|(io_in_a_bits_source[6:4])) | _WIRE_2_3 | _source_ok_WIRE_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6) & (&(io_in_a_bits_address[13:12])))) begin	// @[Misc.scala:201:81, Monitor.scala:42:11, :146:46, :147:68, :640:42, Parameters.scala:46:9, :54:{10,32}, :92:42, :137:65, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        d_first_counter = _RANDOM_1[16:8];	// @[Edges.scala:229:27, Monitor.scala:388:22]
        ...
        a_first_counter_1 = _RANDOM_28[24:16];	// @[Edges.scala:229:27, Monitor.scala:615:33]
        d_first_counter_1 = {_RANDOM_28[31:25], _RANDOM_29[1:0]};	// @[Edges.scala:229:27, Monitor.scala:615:33]
        watchdog = {_RANDOM_29[31:2], _RANDOM_30[1:0]};	// @[Edges.scala:229:27, Monitor.scala:706:27]
        d_first_counter_2 = {_RANDOM_56[31:24], _RANDOM_57[0]};	// @[Edges.scala:229:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial

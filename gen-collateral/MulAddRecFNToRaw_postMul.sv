...
module MulAddRecFNToRaw_postMul(
  ...
  wire [2:0]   _GEN = io_mulAddResult[48] ? io_fromPreMul_highAlignedSigC[2:0] + 3'h1 : io_fromPreMul_highAlignedSigC[2:0];	// @[MulAddRecFN.scala:191:{16,32}, :192:47]
  wire [50:0]  notCDom_absSigSum = _GEN[2] ? ~{_GEN[1:0], io_mulAddResult[47:0], io_fromPreMul_bit0AlignedSigC} : {_GEN[1:0], io_mulAddResult[47:0], io_fromPreMul_bit0AlignedSigC} + {50'h0, io_fromPreMul_doSubMags};	// @[MulAddRecFN.scala:191:16, :195:28, :231:36, :233:12, :234:{13,20}, :235:41]
  ...
  wire [113:0] _notCDom_mainSig_T = {63'h0, notCDom_absSigSum} << {108'h0, notCDom_normDistReduced2, 1'h0};	// @[MulAddRecFN.scala:233:12, :242:27, Mux.scala:47:70]
  ...
  wire         _notNaN_addZeros_T = io_fromPreMul_isZeroA | io_fromPreMul_isZeroB;	// @[MulAddRecFN.scala:266:32]
  assign io_invalidExc = io_fromPreMul_isSigNaNAny | io_fromPreMul_isInfA & io_fromPreMul_isZeroB | io_fromPreMul_isZeroA & io_fromPreMul_isInfB;	// @[MulAddRecFN.scala:271:{31,57}, :272:32]
  assign io_rawOut_isNaN = io_fromPreMul_isNaNAOrB;
  assign io_rawOut_isInf = notNaN_isInfProd;	// @[MulAddRecFN.scala:263:49]
  assign io_rawOut_isZero = _notNaN_addZeros_T | notCDom_completeCancellation;	// @[MulAddRecFN.scala:254:50, :266:32, :281:25]
  assign io_rawOut_sign = notNaN_isInfProd & io_fromPreMul_signProd | _notNaN_addZeros_T & io_fromPreMul_signProd & (io_fromPreMul_signProd ^ io_fromPreMul_doSubMags) | ~notNaN_isInfProd & ~_notNaN_addZeros_T & ~notCDom_completeCancellation & (io_fromPreMul_signProd ^ _GEN[2]);	// @[MulAddRecFN.scala:189:42, :191:16, :231:36, :254:50, :256:12, :258:36, :263:49, :266:32, :284:27, :287:36, :289:50, :290:{10,31,49}]
  assign io_rawOut_sExp = io_fromPreMul_sExpSum - {4'h0, notCDom_normDistReduced2, 1'h0};	// @[MulAddRecFN.scala:240:46, Mux.scala:47:70]
  assign io_rawOut_sig = {_notCDom_mainSig_T[51:26], (|(_notCDom_mainSig_T[25:23])) | (|({|{|(notCDom_absSigSum[23:22]), |(notCDom_absSigSum[21:20])}, |{|(notCDom_absSigSum[19:18]), |(notCDom_absSigSum[17:16])}, |{|(notCDom_absSigSum[15:14]), |(notCDom_absSigSum[13:12])}, |{|(notCDom_absSigSum[11:10]), |(notCDom_absSigSum[9:8])}, |{|(notCDom_absSigSum[7:6]), |(notCDom_absSigSum[5:4])}, |{|(notCDom_absSigSum[3:2]), |(notCDom_absSigSum[1:0])}} & {notCDom_reduced4SigExtra_shift[1], notCDom_reduced4SigExtra_shift[2], notCDom_reduced4SigExtra_shift[3], notCDom_reduced4SigExtra_shift[4], notCDom_reduced4SigExtra_shift[5], notCDom_reduced4SigExtra_shift[6]}))};	// @[Bitwise.scala:114:{18,47}, Cat.scala:33:92, MulAddRecFN.scala:233:12, :242:{27,50}, :246:{39,78}, :248:11, :250:28, :251:{28,35,39}, primitives.scala:77:58, :79:22, :104:{33,54}, :108:20]
endmodule

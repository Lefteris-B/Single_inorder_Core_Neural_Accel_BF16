...
module TLMonitor_32(
  ...
  `ifndef SYNTHESIS
    ...
    wire  [1039:0]   _T_697 = 1040'h0 >> _GEN_21;	// @[Monitor.scala:682:25, :723:35, :793:25]
    ...
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_10 & ~reset & ~(io_in_a_bits_source < 11'h410 & _GEN_8 == 8'h0)) begin	// @[Monitor.scala:42:11, :88:31, :114:53, :115:71, Parameters.scala:57:20, :137:{45,65}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_11 & ~reset & ~(io_in_a_bits_source < 11'h410 & _GEN_8 == 8'h0)) begin	// @[Monitor.scala:42:11, :88:31, :122:56, :123:74, Parameters.scala:57:20, :137:{45,65}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]

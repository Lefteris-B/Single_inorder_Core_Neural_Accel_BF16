...
module ZeroWriter(
  ...
  reg  [11:0] req_bits_laddr_data;	// @[ZeroWriter.scala:37:16]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_bits_laddr_data = {_RANDOM_0[31:21], _RANDOM_1[0]};	// @[ZeroWriter.scala:37:16]
        req_bits_tag_cols = _RANDOM_3[18:3];	// @[ZeroWriter.scala:37:16]
        req_bits_tag_pixel_repeats = _RANDOM_5[28:21];	// @[ZeroWriter.scala:37:16]
        req_bits_tag_cmd_id = {_RANDOM_5[31:29], _RANDOM_6[4:0]};	// @[ZeroWriter.scala:37:16]
        req_bits_cols = _RANDOM_9[20:14];	// @[ZeroWriter.scala:37:16]
        req_bits_block_stride = {_RANDOM_9[31:21], _RANDOM_10[4:0]};	// @[ZeroWriter.scala:37:16]
        col_counter = _RANDOM_10[10:5];	// @[ZeroWriter.scala:37:16, :39:24]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_resp_bits_laddr_data = req_bits_laddr_data + req_bits_block_stride[11:0] * {6'h0, col_counter / 6'h10};	// @[LocalAddr.scala:51:25, Mux.scala:101:16, ZeroWriter.scala:37:16, :39:24, :44:64, :48:20]

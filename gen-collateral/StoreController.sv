...
module StoreController(
  ...
  reg  [33:0] stride;	// @[StoreController.scala:39:19]
  ...
  wire [12:0] _GEN_6 = {11'h0, pool_size};	// @[StoreController.scala:59:22, :82:51, :126:41]
  ...
  always @(posedge clock) begin
    ...
    if (~(|control_state) & _cmd_io_deq_valid & DoConfig) begin	// @[Decoupled.scala:375:21, StoreController.scala:37:30, :39:19, :133:57, :155:38, :222:26, :224:24, :225:24, :226:18]
      stride <= {2'h0, _cmd_io_deq_bits_cmd_rs2[31:0]};	// @[Decoupled.scala:375:21, StoreController.scala:39:19, :70:29, :94:51, :226:18]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        stride = {_RANDOM_0[31:2], _RANDOM_1[3:0]};	// @[StoreController.scala:37:30, :39:19]
        activation = _RANDOM_1[6:4];	// @[StoreController.scala:39:19, :45:23]
        acc_scale_bits = {_RANDOM_5[31:15], _RANDOM_6[14:0]};	// @[StoreController.scala:51:22]
        row_counter = _RANDOM_6[26:15];	// @[StoreController.scala:51:22, :54:28]
        block_counter = {_RANDOM_6[31:27], _RANDOM_7[2:0]};	// @[StoreController.scala:51:22, :55:30]
        pool_stride = _RANDOM_7[4:3];	// @[StoreController.scala:55:30, :58:24]
        pool_size = _RANDOM_7[6:5];	// @[StoreController.scala:55:30, :59:22]
        pool_out_dim = _RANDOM_7[14:7];	// @[StoreController.scala:55:30, :60:25]
        pool_porows = _RANDOM_7[22:15];	// @[StoreController.scala:55:30, :61:24]
        pool_pocols = _RANDOM_7[30:23];	// @[StoreController.scala:55:30, :62:24]
        pool_orows = {_RANDOM_7[31], _RANDOM_8[6:0]};	// @[StoreController.scala:55:30, :63:23]
        pool_ocols = _RANDOM_8[14:7];	// @[StoreController.scala:63:23, :64:23]
        pool_upad = _RANDOM_8[16:15];	// @[StoreController.scala:63:23, :65:22]
        pool_lpad = _RANDOM_8[18:17];	// @[StoreController.scala:63:23, :66:22]
        porow_counter = _RANDOM_8[26:19];	// @[StoreController.scala:63:23, :68:30]
        pocol_counter = {_RANDOM_8[31:27], _RANDOM_9[2:0]};	// @[StoreController.scala:63:23, :69:30]
        wrow_counter = _RANDOM_9[4:3];	// @[StoreController.scala:69:30, :70:29]
        wcol_counter = _RANDOM_9[6:5];	// @[StoreController.scala:69:30, :71:29]
        cmd_id_buf = _RANDOM_9[7];	// @[Reg.scala:19:16, StoreController.scala:69:30]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  DMACommandTracker_1 cmd_tracker (	// @[StoreController.scala:152:27]
    ...
    .io_alloc_bits_bytes_to_read      ((|pool_stride) ? {5'h0, pool_porows} * {5'h0, pool_pocols} * _GEN_6 * _GEN_6 : mvout_1d_enabled ? mvout_1d_rows[12:0] : {1'h0, {7'h0, _cmd_io_deq_bits_cmd_rs2[52:48]} * {5'h0, blocks}}),	// @[Decoupled.scala:375:21, StoreController.scala:37:30, :58:24, :61:24, :62:24, :73:58, :74:44, :82:{37,51,63}, :87:44, :91:{55,78}, :139:34, :182:{49,74,112}]
  ...
  assign io_dma_req_bits_vaddr = _T_17 ? _cmd_io_deq_bits_cmd_rs1[33:0] + {18'h0, {8'h0, porow_counter} * {8'h0, pool_out_dim} + {8'h0, pocol_counter}} * stride : _cmd_io_deq_bits_cmd_rs1[33:0] + {22'h0, row_counter} * stride;	// @[Decoupled.scala:375:21, StoreController.scala:39:19, :54:28, :55:30, :60:25, :68:30, :69:30, :123:{29,43}, :131:{26,43,58,75}, :160:{31,51}]
  ...
  assign io_dma_req_bits_laddr_garbage = _cmd_io_deq_bits_cmd_rs2[25:13];	// @[Decoupled.scala:375:21, StoreController.scala:87:44]
  assign io_dma_req_bits_laddr_garbage_bit = _GEN_7 | _cmd_io_deq_bits_cmd_rs2[12];	// @[Decoupled.scala:375:21, StoreController.scala:87:44, :161:31]
  assign io_dma_req_bits_laddr_data = (|pool_stride) ? (_T_8 ? 12'hFFF : _cmd_io_deq_bits_cmd_rs2[11:0] + {1'h0, orow} * {4'h0, pool_ocols} + {1'h0, ocol}) : _cmd_io_deq_bits_cmd_rs2[11:0] + {block_counter, 4'h0} + row_counter;	// @[Decoupled.scala:375:21, LocalAddr.scala:51:{17,25}, :99:{10,13}, StoreController.scala:37:30, :54:28, :55:30, :58:24, :64:23, :73:58, :76:58, :79:58, :87:44, :124:78, :126:{41,54}, :127:{68,91}, :161:31, :182:74]

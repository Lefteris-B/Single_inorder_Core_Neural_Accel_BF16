...
module TLMonitor_27(
  ...
  `ifndef SYNTHESIS
    ...
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_13 & ~reset & ~((io_in_a_bits_source[6:4] == 3'h2 | io_in_a_bits_source[6:4] == 3'h1 | ~(|(io_in_a_bits_source[6:4])) | _WIRE_2_3 | _source_ok_WIRE_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6) & io_in_a_bits_size != 3'h7 & io_in_a_bits_address[25:12] == 14'h2010)) begin	// @[Misc.scala:201:81, Monitor.scala:42:11, :92:25, :114:53, :115:71, :640:42, Parameters.scala:46:9, :54:{10,32}, :92:42, :137:{31,65}, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_14 & ~reset & ~((io_in_a_bits_source[6:4] == 3'h2 | io_in_a_bits_source[6:4] == 3'h1 | ~(|(io_in_a_bits_source[6:4])) | _WIRE_2_3 | _source_ok_WIRE_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6) & io_in_a_bits_size != 3'h7 & io_in_a_bits_address[25:12] == 14'h2010)) begin	// @[Misc.scala:201:81, Monitor.scala:42:11, :92:25, :122:56, :123:74, :640:42, Parameters.scala:46:9, :54:{10,32}, :92:42, :137:{31,65}, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        d_first_counter = _RANDOM_1[15:13];	// @[Edges.scala:229:27, Monitor.scala:388:22]
        ...
        a_first_counter_1 = _RANDOM_20[12:10];	// @[Edges.scala:229:27, Monitor.scala:615:33]
        d_first_counter_1 = _RANDOM_20[15:13];	// @[Edges.scala:229:27, Monitor.scala:615:33]
        watchdog = {_RANDOM_20[31:16], _RANDOM_21[15:0]};	// @[Monitor.scala:615:33, :706:27]
        d_first_counter_2 = _RANDOM_39[30:28];	// @[Edges.scala:229:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial

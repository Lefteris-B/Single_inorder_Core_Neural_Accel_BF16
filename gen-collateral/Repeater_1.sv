  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        saved_sink = _RANDOM_0[17:14];	// @[Repeater.scala:19:21, :20:18]
        saved_denied = _RANDOM_0[18];	// @[Repeater.scala:19:21, :20:18]
        saved_data = {_RANDOM_0[31:19], _RANDOM_1, _RANDOM_2, _RANDOM_3, _RANDOM_4[18:0]};	// @[Repeater.scala:19:21, :20:18]
        saved_corrupt = _RANDOM_4[19];	// @[Repeater.scala:20:18]
      `endif // RANDOMIZE_REG_INIT
    end // initial

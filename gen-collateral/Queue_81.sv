...
module Queue_81(
  ...
  wire [268:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_cols = _ram_ext_R0_data[81:66];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_repeats = _ram_ext_R0_data[97:82];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_scale = _ram_ext_R0_data[129:98];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_has_acc_bitwidth = _ram_ext_R0_data[130];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_block_stride = _ram_ext_R0_data[147:132];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_pixel_repeats = _ram_ext_R0_data[155:148];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_cmd_id = _ram_ext_R0_data[163:156];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_status_debug = _ram_ext_R0_data[164];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_status_cease = _ram_ext_R0_data[165];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_status_wfi = _ram_ext_R0_data[166];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_status_isa = _ram_ext_R0_data[198:167];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_status_dprv = _ram_ext_R0_data[200:199];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_status_dv = _ram_ext_R0_data[201];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_status_prv = _ram_ext_R0_data[203:202];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_status_v = _ram_ext_R0_data[204];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_status_sd = _ram_ext_R0_data[205];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_status_zero2 = _ram_ext_R0_data[228:206];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_status_mpv = _ram_ext_R0_data[229];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_status_gva = _ram_ext_R0_data[230];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_status_mbe = _ram_ext_R0_data[231];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_status_sbe = _ram_ext_R0_data[232];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_status_sxl = _ram_ext_R0_data[234:233];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_status_uxl = _ram_ext_R0_data[236:235];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_status_sd_rv32 = _ram_ext_R0_data[237];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_status_zero1 = _ram_ext_R0_data[245:238];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_status_tsr = _ram_ext_R0_data[246];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_status_tw = _ram_ext_R0_data[247];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_status_tvm = _ram_ext_R0_data[248];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_status_mxr = _ram_ext_R0_data[249];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_status_sum = _ram_ext_R0_data[250];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_status_mprv = _ram_ext_R0_data[251];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_status_xs = _ram_ext_R0_data[253:252];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_status_fs = _ram_ext_R0_data[255:254];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_status_mpp = _ram_ext_R0_data[257:256];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_status_vs = _ram_ext_R0_data[259:258];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_status_spp = _ram_ext_R0_data[260];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_status_mpie = _ram_ext_R0_data[261];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_status_ube = _ram_ext_R0_data[262];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_status_spie = _ram_ext_R0_data[263];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_status_upie = _ram_ext_R0_data[264];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_status_mie = _ram_ext_R0_data[265];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_status_hie = _ram_ext_R0_data[266];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_status_sie = _ram_ext_R0_data[267];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_status_uie = _ram_ext_R0_data[268];	// @[Decoupled.scala:273:95]
endmodule

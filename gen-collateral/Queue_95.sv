...
module Queue_95(
  ...
  input  [12:0] io_enq_bits_c_addr_garbage,
  input         io_enq_bits_c_addr_garbage_bit,
  input  [11:0] io_enq_bits_c_addr_data,
  ...
  output [11:0] io_deq_bits_c_addr_data,
  ...
  assign io_deq_bits_c_addr_garbage_bit = _ram_ext_R0_data[57];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_c_addr_data = _ram_ext_R0_data[69:58];	// @[Decoupled.scala:273:95]

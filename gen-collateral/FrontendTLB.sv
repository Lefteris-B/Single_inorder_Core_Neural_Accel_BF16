...
module FrontendTLB(
  ...
  input  [33:0] io_clients_0_req_bits_tlb_req_vaddr,
  ...
  input  [33:0] io_clients_1_req_bits_tlb_req_vaddr,
  ...
  wire [33:0] _tlbArbOpt_io_out_bits_tlb_req_vaddr;	// @[FrontendTLB.scala:107:50]
  ...
  reg  [32:0] last_translated_vpn;	// @[FrontendTLB.scala:119:38]
  ...
  reg  [33:0] tlbArbOpt_io_in_0_bits_REG_tlb_req_vaddr;	// @[FrontendTLB.scala:131:22]
  ...
  reg  [32:0] last_translated_vpn_1;	// @[FrontendTLB.scala:119:38]
  ...
  reg  [33:0] tlbArbOpt_io_in_1_bits_REG_tlb_req_vaddr;	// @[FrontendTLB.scala:131:22]
  ...
  wire        l0_tlb_hit = last_translated_valid & io_clients_0_req_bits_tlb_req_vaddr[33:12] == {1'h0, last_translated_vpn[32:12]};	// @[FrontendTLB.scala:118:40, :119:38, :122:{44,79,100,125}]
  wire        l0_tlb_hit_1 = last_translated_valid_1 & io_clients_1_req_bits_tlb_req_vaddr[33:12] == {1'h0, last_translated_vpn_1[32:12]};	// @[FrontendTLB.scala:118:40, :119:38, :122:{44,79,100,125}]
  always @(posedge clock) begin
    if (reset) begin
      last_translated_valid <= 1'h0;	// @[FrontendTLB.scala:118:40]
      last_translated_vpn <= 33'h0;	// @[FrontendTLB.scala:119:38]
      last_translated_ppn <= 32'h0;	// @[FrontendTLB.scala:120:38]
      last_translated_valid_1 <= 1'h0;	// @[FrontendTLB.scala:118:40]
      last_translated_vpn_1 <= 33'h0;	// @[FrontendTLB.scala:119:38]
      ...
      if (tlbReqFire) begin	// @[Decoupled.scala:51:35]
        last_translated_vpn <= tlbArbOpt_io_in_0_bits_REG_tlb_req_vaddr[32:0];	// @[FrontendTLB.scala:119:38, :131:22, :135:27]
      ...
      if (tlbReqFire_1) begin	// @[Decoupled.scala:51:35]
        last_translated_vpn_1 <= tlbArbOpt_io_in_1_bits_REG_tlb_req_vaddr[32:0];	// @[FrontendTLB.scala:119:38, :131:22, :135:27]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        last_translated_vpn = {_RANDOM_0[31:1], _RANDOM_1[1:0]};	// @[FrontendTLB.scala:118:40, :119:38]
        last_translated_ppn = {_RANDOM_1[31:2], _RANDOM_2[1:0]};	// @[FrontendTLB.scala:119:38, :120:38]
        tlbArbOpt_io_in_0_valid_REG = _RANDOM_2[2];	// @[FrontendTLB.scala:120:38, :130:27]
        tlbArbOpt_io_in_0_bits_REG_tlb_req_vaddr = {_RANDOM_2[31:3], _RANDOM_3[4:0]};	// @[FrontendTLB.scala:120:38, :131:22]
        tlbArbOpt_io_in_0_bits_REG_status_debug = _RANDOM_3[16];	// @[FrontendTLB.scala:131:22]
        tlbArbOpt_io_in_0_bits_REG_status_mxr = _RANDOM_6[5];	// @[FrontendTLB.scala:131:22]
        tlbArbOpt_io_in_0_bits_REG_status_sum = _RANDOM_6[6];	// @[FrontendTLB.scala:131:22]
        io_clients_0_resp_paddr_REG = {_RANDOM_6[31:25], _RANDOM_7[24:0]};	// @[FrontendTLB.scala:131:22, :147:35]
        io_clients_0_resp_miss_REG = _RANDOM_7[25];	// @[FrontendTLB.scala:147:35, :148:35]
        last_translated_valid_1 = _RANDOM_7[26];	// @[FrontendTLB.scala:118:40, :147:35]
        last_translated_vpn_1 = {_RANDOM_7[31:27], _RANDOM_8[27:0]};	// @[FrontendTLB.scala:119:38, :147:35]
        last_translated_ppn_1 = {_RANDOM_8[31:28], _RANDOM_9[27:0]};	// @[FrontendTLB.scala:119:38, :120:38]
        tlbArbOpt_io_in_1_valid_REG = _RANDOM_9[28];	// @[FrontendTLB.scala:120:38, :130:27]
        tlbArbOpt_io_in_1_bits_REG_tlb_req_vaddr = {_RANDOM_9[31:29], _RANDOM_10[30:0]};	// @[FrontendTLB.scala:120:38, :131:22]
        tlbArbOpt_io_in_1_bits_REG_status_debug = _RANDOM_11[10];	// @[FrontendTLB.scala:131:22]
        tlbArbOpt_io_in_1_bits_REG_status_mxr = _RANDOM_13[31];	// @[FrontendTLB.scala:131:22]
        tlbArbOpt_io_in_1_bits_REG_status_sum = _RANDOM_14[0];	// @[FrontendTLB.scala:131:22]
        io_clients_1_resp_paddr_REG = {_RANDOM_14[31:19], _RANDOM_15[18:0]};	// @[FrontendTLB.scala:131:22, :147:35]
        io_clients_1_resp_miss_REG = _RANDOM_15[19];	// @[FrontendTLB.scala:147:35, :148:35]
      `endif // RANDOMIZE_REG_INIT
    end // initial

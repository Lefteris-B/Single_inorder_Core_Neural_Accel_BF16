  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s2_req_source = _RANDOM_1[23:20];	// @[Reg.scala:19:16]
        s2_req_tag = {_RANDOM_1[31:24], _RANDOM_2[3:0]};	// @[Reg.scala:19:16]
        ...
        s3_req_source = {_RANDOM_2[31:29], _RANDOM_3[0]};	// @[Reg.scala:19:16]
        s3_req_tag = _RANDOM_3[12:1];	// @[Reg.scala:19:16]

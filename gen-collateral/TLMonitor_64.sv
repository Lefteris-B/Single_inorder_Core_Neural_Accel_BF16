...
module TLMonitor_64(
  ...
  `ifndef SYNTHESIS
    ...
    wire  [4159:0]   _GEN_20 = {4147'h0, io_in_d_bits_source, 2'h0};	// @[Monitor.scala:634:44]
    ...
    wire  [1039:0]   _T_697 = inflight_1 >> _GEN_21;	// @[Monitor.scala:682:25, :723:35, :793:25]
    wire  [4159:0]   _c_size_lookup_T_1 = inflight_sizes_1 >> _GEN_20;	// @[Monitor.scala:634:44, :725:35, :747:42]
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_10 & ~reset & ~(io_in_a_bits_source < 11'h410 & io_in_a_bits_address[20:12] == 9'h100)) begin	// @[Monitor.scala:42:11, :114:53, :115:71, Parameters.scala:57:20, :137:{31,65}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_11 & ~reset & ~(io_in_a_bits_source < 11'h410 & io_in_a_bits_address[20:12] == 9'h100)) begin	// @[Monitor.scala:42:11, :122:56, :123:74, Parameters.scala:57:20, :137:{31,65}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]

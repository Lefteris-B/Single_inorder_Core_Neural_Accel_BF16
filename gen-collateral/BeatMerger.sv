...
module BeatMerger(
  ...
  reg  [11:0]   req_bits_addr;	// @[BeatMerger.scala:43:16]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_bits_addr = _RANDOM_0[18:7];	// @[BeatMerger.scala:43:16]
        req_bits_is_acc = _RANDOM_0[19];	// @[BeatMerger.scala:43:16]
        req_bits_accumulate = _RANDOM_0[20];	// @[BeatMerger.scala:43:16]
        req_bits_has_acc_bitwidth = _RANDOM_0[21];	// @[BeatMerger.scala:43:16]
        req_bits_block_stride = {_RANDOM_2[31:30], _RANDOM_3[13:0]};	// @[BeatMerger.scala:43:16]
        req_bits_spad_row_offset = _RANDOM_3[22:14];	// @[BeatMerger.scala:43:16]
        req_bits_lg_len_req = _RANDOM_3[25:23];	// @[BeatMerger.scala:43:16]
        req_bits_bytes_to_read = {_RANDOM_3[31:26], _RANDOM_4[0]};	// @[BeatMerger.scala:43:16]
        buffer = {_RANDOM_4[31:2], _RANDOM_5, _RANDOM_6, _RANDOM_7, _RANDOM_8, _RANDOM_9, _RANDOM_10, _RANDOM_11, _RANDOM_12, _RANDOM_13, _RANDOM_14, _RANDOM_15, _RANDOM_16, _RANDOM_17, _RANDOM_18, _RANDOM_19, _RANDOM_20[1:0]};	// @[BeatMerger.scala:43:16, :46:19]
        bytesSent = _RANDOM_20[8:2];	// @[BeatMerger.scala:46:19, :50:22]
        bytesRead = _RANDOM_20[15:9];	// @[BeatMerger.scala:46:19, :51:22]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_out_bits_addr = req_bits_addr + req_bits_block_stride[11:0] * {3'h0, req_bits_has_acc_bitwidth ? io_out_bits_addr_total_bytes_sent / 9'h40 : io_out_bits_addr_total_bytes_sent / 9'h10};	// @[BeatMerger.scala:43:16, :58:32, :76:{37,61}, :77:53, :78:8, :82:84, :83:85]

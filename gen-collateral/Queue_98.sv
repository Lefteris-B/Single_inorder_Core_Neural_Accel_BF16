...
module Queue_98(
  ...
  ram_combMem_40 ram_ext (	// @[Decoupled.scala:273:95]
    ...
    .W0_clk  (clock),
    .W0_data ({3'h0, io_enq_bits_status_mie, 3'h0, io_enq_bits_status_mpie, 30'h6600000, io_enq_bits_status_gva, 31'h5B, io_enq_bits_status_isa, io_enq_bits_status_wfi, io_enq_bits_status_cease, io_enq_bits_status_debug, io_enq_bits_rs2, io_enq_bits_rs1, io_enq_bits_inst_opcode, io_enq_bits_inst_rd, io_enq_bits_inst_xs2, io_enq_bits_inst_xs1, io_enq_bits_inst_xd, io_enq_bits_inst_rs1, io_enq_bits_inst_rs2, io_enq_bits_inst_funct}),	// @[Decoupled.scala:273:95]

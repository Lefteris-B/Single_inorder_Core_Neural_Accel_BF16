...
module TLMonitor_4(
  ...
  wire         _T_1279 = io_in_a_ready & io_in_a_valid;	// @[Decoupled.scala:51:35]
  ...
  wire         _T_1203 = _T_1279 & a_first_1;	// @[Decoupled.scala:51:35, Edges.scala:231:25, Monitor.scala:652:27]
  ...
  wire [258:0] _a_opcodes_set_T_1 = {255'h0, _T_1203 ? {io_in_a_bits_opcode, 1'h1} : 4'h0} << {252'h0, io_in_a_bits_source, 2'h0};	// @[Monitor.scala:42:11, :643:40, :652:{27,72}, :654:{28,53}, :656:54, :657:52, OneHot.scala:64:12, Parameters.scala:52:29]
  wire [270:0] _d_sizes_clr_T_5 = 271'hFF << {263'h0, io_in_d_bits_source, 3'h0};	// @[Bundles.scala:259:74, Monitor.scala:677:76, :678:74]
  wire [259:0] _a_sizes_set_T_1 = {255'h0, _T_1203 ? {io_in_a_bits_size, 1'h1} : 5'h0} << {252'h0, io_in_a_bits_source, 3'h0};	// @[Bundles.scala:259:74, Monitor.scala:42:11, :645:38, :652:{27,72}, :655:{28,51}, :656:54, :657:52]
  wire         _T_1352 = io_in_d_ready & io_in_d_valid;	// @[Decoupled.scala:51:35]
  wire         _T_1218 = _T_1352 & d_first_1 & ~d_release_ack;	// @[Decoupled.scala:51:35, Edges.scala:231:25, Monitor.scala:670:46, :671:74, :675:72]
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (_T_1279) begin	// @[Decoupled.scala:51:35]
      ...
      if (_T_1352) begin	// @[Decoupled.scala:51:35]
      ...
      inflight <= (inflight | (_T_1203 ? 32'h1 << _GEN_0 : 32'h0)) & ~(_T_1218 ? 32'h1 << _GEN_1 : 32'h0);	// @[Monitor.scala:611:27, :623:34, :652:{27,72}, :653:28, :661:34, :675:{72,91}, :676:21, :702:{27,36,38}, :723:35, OneHot.scala:57:35]
      inflight_opcodes <= (inflight_opcodes | (_T_1203 ? _a_opcodes_set_T_1[127:0] : 128'h0)) & ~(_T_1218 ? _d_opcodes_clr_T_5[127:0] : 128'h0);	// @[Monitor.scala:613:35, :627:33, :652:{27,72}, :656:{28,54}, :665:33, :675:{72,91}, :677:{21,76}, :703:{43,60,62}, :724:35]
      inflight_sizes <= (inflight_sizes | (_T_1203 ? _a_sizes_set_T_1[255:0] : 256'h0)) & ~(_T_1218 ? _d_sizes_clr_T_5[255:0] : 256'h0);	// @[Monitor.scala:615:33, :629:31, :652:{27,72}, :657:{28,52}, :667:31, :675:{72,91}, :678:{21,74}, :704:{39,54,56}, :725:35]
      if (_T_1279 | _T_1352)	// @[Decoupled.scala:51:35, Monitor.scala:712:27]
        watchdog <= 32'h0;	// @[Monitor.scala:706:27, :723:35]
      else	// @[Monitor.scala:712:27]
        watchdog <= watchdog + 32'h1;	// @[Monitor.scala:706:27, :711:26, OneHot.scala:57:35]
    end
    if (_T_1279 & ~(|a_first_counter)) begin	// @[Decoupled.scala:51:35, Edges.scala:229:27, :231:25, Monitor.scala:396:20]
    ...
    if (_T_1352 & ~(|d_first_counter)) begin	// @[Decoupled.scala:51:35, Edges.scala:229:27, :231:25, Monitor.scala:549:20]
  ...
  `ifndef SYNTHESIS
    ...
    wire             _T_399 = io_in_a_bits_size < 4'hD;	// @[Parameters.scala:92:42]
    ...
    wire             _T_917 = io_in_a_bits_size < 4'hD;	// @[Parameters.scala:92:42]
    ...
    wire             _T_1148 = io_in_a_valid & (|a_first_counter);	// @[Edges.scala:229:27, :231:25, Monitor.scala:389:19]
    wire             _T_1172 = io_in_d_valid & (|d_first_counter);	// @[Edges.scala:229:27, :231:25, Monitor.scala:541:19]
    ...
    wire             _T_1251 = io_in_d_valid & d_first_1;	// @[Edges.scala:231:25, Monitor.scala:671:26]
    wire             _T_1222 = _T_1251 & ~d_release_ack;	// @[Monitor.scala:670:46, :671:{26,74}, :680:71]
    wire             same_cycle_resp = _same_cycle_resp_T_1 & io_in_a_bits_source == io_in_d_bits_source;	// @[Monitor.scala:648:26, :681:{88,113}]
    wire             _GEN_27 = _T_1222 & same_cycle_resp;	// @[Monitor.scala:680:71, :681:88, :684:30]
    wire             _GEN_28 = _T_1222 & ~same_cycle_resp;	// @[Monitor.scala:680:71, :681:88, :684:30]
    wire  [7:0]      _GEN_29 = {4'h0, io_in_d_bits_size};	// @[Monitor.scala:691:36, Parameters.scala:52:29]
    wire             _T_1308 = io_in_d_valid & d_first_2 & d_release_ack;	// @[Edges.scala:231:25, Monitor.scala:670:46, :791:71]
    wire  [31:0]     _T_1204 = inflight >> _GEN_0;	// @[Monitor.scala:611:27, :658:26, OneHot.scala:57:35]
    wire  [31:0]     _T_1223 = inflight >> _GEN_1;	// @[Monitor.scala:611:27, :682:25, OneHot.scala:57:35]
    wire  [255:0]    _a_size_lookup_T_1 = inflight_sizes >> _GEN_26;	// @[Monitor.scala:615:33, :638:40]
    wire  [31:0]     _T_1309 = 32'h0 >> _GEN_1;	// @[Monitor.scala:723:35, :793:25, OneHot.scala:57:35]
    ...
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_9 & ~reset & ~_T_399) begin	// @[Monitor.scala:42:11, :104:45, Parameters.scala:92:42]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
          $error("Assertion failed: 'A' channel carries Get type which master claims it can't emit (connected at SystemBus.scala:41:96)\n    at Monitor.scala:42 assert(cond, message)\n");	// @[Monitor.scala:42:11]
        if (`STOP_COND_)	// @[Monitor.scala:42:11]
          $fatal;	// @[Monitor.scala:42:11]
      end
      if (_GEN_9 & ~reset & ~(_T_399 & io_in_a_bits_address[31:12] == 20'h3 | io_in_a_bits_size < 4'h7 & (_GEN_10 == 19'h0 | io_in_a_bits_address[31:16] == 16'h1 | _GEN_11 == 19'h0 | io_in_a_bits_address[31:16] == 16'h200 | io_in_a_bits_address[31:12] == 20'h2010 | io_in_a_bits_address[31:26] == 6'h3 | io_in_a_bits_address[31:12] == 20'h54000 | io_in_a_bits_address[31:28] == 4'h8))) begin	// @[Monitor.scala:42:11, :104:45, Parameters.scala:92:42, :137:{31,45,65}, :671:54, :672:42, :673:26]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_13 & ~reset & ~(_T_503 & (_T_503 & io_in_a_bits_address[31:12] == 20'h3 | io_in_a_bits_size < 4'h7 & (_GEN_10 == 19'h0 | _GEN_11 == 19'h0 | io_in_a_bits_address[31:16] == 16'h200 | io_in_a_bits_address[31:12] == 20'h2010 | io_in_a_bits_address[31:26] == 6'h3 | io_in_a_bits_address[31:12] == 20'h54000 | io_in_a_bits_address[31:28] == 4'h8)))) begin	// @[Monitor.scala:42:11, :114:53, :115:71, Parameters.scala:92:42, :137:{31,45,65}, :671:54, :672:42, :673:26]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_14 & ~reset & ~(_T_606 & (_T_606 & io_in_a_bits_address[31:12] == 20'h3 | io_in_a_bits_size < 4'h7 & (_GEN_10 == 19'h0 | _GEN_11 == 19'h0 | io_in_a_bits_address[31:16] == 16'h200 | io_in_a_bits_address[31:12] == 20'h2010 | io_in_a_bits_address[31:26] == 6'h3 | io_in_a_bits_address[31:12] == 20'h54000 | io_in_a_bits_address[31:28] == 4'h8)))) begin	// @[Monitor.scala:42:11, :122:56, :123:74, Parameters.scala:92:42, :137:{31,45,65}, :671:54, :672:42, :673:26]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_17 & ~reset & ~(_T_917 & (_T_917 & io_in_a_bits_address[31:12] == 20'h3 | io_in_a_bits_size < 4'h7 & io_in_a_bits_address[31:28] == 4'h8))) begin	// @[Monitor.scala:42:11, :146:46, :147:68, Parameters.scala:92:42, :137:{31,65}, :671:54, :673:26]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_T_1251 & a_first_1 & io_in_a_valid & io_in_a_bits_source == io_in_d_bits_source & ~d_release_ack & ~reset & ~(~io_in_d_ready | io_in_a_ready)) begin	// @[Edges.scala:231:25, Monitor.scala:49:11, :670:46, :671:{26,74}, :694:90, :695:{15,32}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: ready check\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      if (~reset & ~(a_set_wo_ready != (_T_1251 & ~d_release_ack ? 32'h1 << _GEN_1 : 32'h0) | a_set_wo_ready == 32'h0)) begin	// @[Monitor.scala:49:11, :624:34, :648:71, :649:22, :662:34, :670:46, :671:{26,71,74,90}, :672:22, :699:{29,48,67}, :723:35, OneHot.scala:57:35]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
      ...
      if (_T_1308 & ~reset & ~(_T_1309[0])) begin	// @[Monitor.scala:49:11, :791:71, :793:25]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel acknowledged for nothing inflight (connected at SystemBus.scala:41:96)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      if (_T_1308 & ~reset & _GEN_29 != {1'h0, _c_size_lookup_T_1[7:1]}) begin	// @[Monitor.scala:42:11, :49:11, :691:36, :747:{21,42}, :791:71, :797:36]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel contains improper response size (connected at SystemBus.scala:41:96)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        source = _RANDOM_0[22:18];	// @[Edges.scala:229:27, Monitor.scala:387:22]
        address = {_RANDOM_0[31:23], _RANDOM_1[22:0]};	// @[Edges.scala:229:27, Monitor.scala:388:22]
        d_first_counter = _RANDOM_1[30:23];	// @[Edges.scala:229:27, Monitor.scala:388:22]
        ...
        a_first_counter_1 = _RANDOM_15[25:18];	// @[Edges.scala:229:27, Monitor.scala:615:33]
        d_first_counter_1 = {_RANDOM_15[31:26], _RANDOM_16[1:0]};	// @[Edges.scala:229:27, Monitor.scala:615:33]
        watchdog = {_RANDOM_16[31:2], _RANDOM_17[1:0]};	// @[Edges.scala:229:27, Monitor.scala:706:27]
        d_first_counter_2 = _RANDOM_30[17:10];	// @[Edges.scala:229:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial

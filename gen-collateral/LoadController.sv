...
module LoadController(
  ...
  output        io_cmd_ready,
                io_dma_req_valid,
  output [33:0] io_dma_req_bits_vaddr,
  ...
  output [12:0] io_dma_req_bits_laddr_garbage,
  output        io_dma_req_bits_laddr_garbage_bit,
  output [11:0] io_dma_req_bits_laddr_data,
  ...
  reg  [33:0]      strides_0;	// @[LoadController.scala:33:20]
  reg  [33:0]      strides_1;	// @[LoadController.scala:33:20]
  reg  [33:0]      strides_2;	// @[LoadController.scala:33:20]
  ...
  reg  [11:0]      block_strides_0;	// @[LoadController.scala:36:26]
  reg  [11:0]      block_strides_1;	// @[LoadController.scala:36:26]
  reg  [11:0]      block_strides_2;	// @[LoadController.scala:36:26]
  ...
  wire [3:0][33:0] _GEN = {{strides_0}, {strides_2}, {strides_1}, {strides_0}};	// @[LoadController.scala:33:20, :76:37]
  wire [33:0]      _GEN_0 = _GEN[state_id];	// @[LoadController.scala:64:21, :76:37]
  wire             _io_dma_req_bits_repeats_T = _GEN_0 == 34'h0;	// @[LoadController.scala:76:37]
  ...
  wire [3:0][11:0] _GEN_1 = {{block_strides_0}, {block_strides_2}, {block_strides_1}, {block_strides_0}};	// @[LoadController.scala:36:26, :106:32]
  wire [11:0]      _GEN_2 = _GEN_1[state_id];	// @[LoadController.scala:64:21, :106:32]
  ...
  always @(posedge clock) begin
    ...
    if (_T_5 & _cmd_io_deq_valid & ~(|_cmd_io_deq_bits_cmd_inst_funct) & state_id == 2'h0) begin	// @[Decoupled.scala:375:21, LoadController.scala:31:30, :33:20, :64:{21,46}, :99:38, :140:26, :142:24, :143:24, :144:18]
      strides_0 <= _cmd_io_deq_bits_cmd_rs2[33:0];	// @[Decoupled.scala:375:21, LoadController.scala:33:20, :144:18]
      ...
      block_strides_0 <= _cmd_io_deq_bits_cmd_rs1[27:16];	// @[Decoupled.scala:375:21, LoadController.scala:36:26, :52:50]
    ...
    if (_T_5 & _cmd_io_deq_valid & ~(|_cmd_io_deq_bits_cmd_inst_funct) & state_id == 2'h1) begin	// @[Decoupled.scala:375:21, LoadController.scala:33:20, :64:{21,46}, :99:38, :100:19, :140:26, :142:24, :143:24, :144:18]
      strides_1 <= _cmd_io_deq_bits_cmd_rs2[33:0];	// @[Decoupled.scala:375:21, LoadController.scala:33:20, :144:18]
      ...
      block_strides_1 <= _cmd_io_deq_bits_cmd_rs1[27:16];	// @[Decoupled.scala:375:21, LoadController.scala:36:26, :52:50]
      if (_pixel_repeats_T)	// @[LoadController.scala:148:52]
    ...
    if (_T_5 & _cmd_io_deq_valid & ~(|_cmd_io_deq_bits_cmd_inst_funct) & state_id == 2'h2) begin	// @[Decoupled.scala:375:21, LoadController.scala:33:20, :64:{21,46}, :99:38, :140:26, :142:24, :143:24, :144:18, Mux.scala:101:16]
      strides_2 <= _cmd_io_deq_bits_cmd_rs2[33:0];	// @[Decoupled.scala:375:21, LoadController.scala:33:20, :144:18]
      ...
      block_strides_2 <= _cmd_io_deq_bits_cmd_rs1[27:16];	// @[Decoupled.scala:375:21, LoadController.scala:36:26, :52:50]
      if (_pixel_repeats_T)	// @[LoadController.scala:148:52]
  ...
  `ifndef SYNTHESIS
    always @(posedge clock) begin	// @[Util.scala:19:11]
      ...
      if (_last_row_T_4 & ~reset & _GEN_2 < {7'h0, _cmd_io_deq_bits_cmd_rs2[52:48]}) begin	// @[Decoupled.scala:51:35, :375:21, LoadController.scala:45:43, :64:46, :106:32, :136:{11,25}]
      ...
      if (~reset & _T_15 & _GEN_7 == 11'h0) begin	// @[DMACommandTracker.scala:27:40, LoadController.scala:105:27, :116:8, :189:{9,83}]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        strides_0 = {_RANDOM_0[31:2], _RANDOM_1[3:0]};	// @[LoadController.scala:31:30, :33:20]
        strides_1 = {_RANDOM_1[31:4], _RANDOM_2[5:0]};	// @[LoadController.scala:33:20]
        strides_2 = {_RANDOM_2[31:6], _RANDOM_3[7:0]};	// @[LoadController.scala:33:20]
        scales_0 = {_RANDOM_3[31:8], _RANDOM_4[7:0]};	// @[LoadController.scala:33:20, :34:19]
        scales_1 = {_RANDOM_4[31:8], _RANDOM_5[7:0]};	// @[LoadController.scala:34:19]
        scales_2 = {_RANDOM_5[31:8], _RANDOM_6[7:0]};	// @[LoadController.scala:34:19]
        shrinks_0 = _RANDOM_6[8];	// @[LoadController.scala:34:19, :35:20]
        shrinks_1 = _RANDOM_6[9];	// @[LoadController.scala:34:19, :35:20]
        shrinks_2 = _RANDOM_6[10];	// @[LoadController.scala:34:19, :35:20]
        block_strides_0 = _RANDOM_6[22:11];	// @[LoadController.scala:34:19, :36:26]
        block_strides_1 = {_RANDOM_6[31:23], _RANDOM_7[2:0]};	// @[LoadController.scala:34:19, :36:26]
        block_strides_2 = _RANDOM_7[14:3];	// @[LoadController.scala:36:26]
        pixel_repeats_0 = _RANDOM_7[19:15];	// @[LoadController.scala:36:26, :37:26]
        pixel_repeats_1 = _RANDOM_7[24:20];	// @[LoadController.scala:36:26, :37:26]
        pixel_repeats_2 = _RANDOM_7[29:25];	// @[LoadController.scala:36:26, :37:26]
        row_counter = {_RANDOM_7[31:30], _RANDOM_8[1:0]};	// @[LoadController.scala:36:26, :40:28]
        cmd_id_buf = _RANDOM_8[2];	// @[LoadController.scala:40:28, Reg.scala:19:16]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_dma_req_bits_vaddr = _cmd_io_deq_bits_cmd_rs1[33:0] + {30'h0, row_counter} * _GEN_0;	// @[Decoupled.scala:375:21, LoadController.scala:40:28, :76:37, :102:{34,48}]
  ...
  assign io_dma_req_bits_laddr_garbage = _cmd_io_deq_bits_cmd_rs2[25:13];	// @[Decoupled.scala:375:21, LoadController.scala:45:43]
  assign io_dma_req_bits_laddr_garbage_bit = _cmd_io_deq_bits_cmd_rs2[12];	// @[Decoupled.scala:375:21, LoadController.scala:45:43]
  assign io_dma_req_bits_laddr_data = _cmd_io_deq_bits_cmd_rs2[11:0] + {8'h0, row_counter};	// @[Decoupled.scala:375:21, LoadController.scala:40:28, :45:43, LocalAddr.scala:51:25]
  assign io_dma_req_bits_cols = {9'h0, _cmd_io_deq_bits_cmd_rs2[38:32]};	// @[Decoupled.scala:375:21, LoadController.scala:45:43, :104:24, LocalAddr.scala:51:25]
  assign io_dma_req_bits_repeats = {11'h0, _io_dma_req_bits_repeats_T & (|_cmd_io_deq_bits_cmd_rs1) ? _cmd_io_deq_bits_cmd_rs2[52:48] - 5'h1 : 5'h0};	// @[Decoupled.scala:375:21, LoadController.scala:45:43, :72:25, :76:37, :105:{27,33,49,69}]
  ...
  assign io_dma_req_bits_block_stride = {4'h0, _GEN_2};	// @[LoadController.scala:40:28, :106:32]

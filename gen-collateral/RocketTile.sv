...
module RocketTile(
  input          clock,
                 ...
                 auto_buffer_out_1_b_valid,
  input  [2:0]   auto_buffer_out_1_b_bits_opcode,
  input  [1:0]   auto_buffer_out_1_b_bits_param,
  input  [3:0]   auto_buffer_out_1_b_bits_size,
  input  [1:0]   auto_buffer_out_1_b_bits_source,
  input  [31:0]  auto_buffer_out_1_b_bits_address,
  input  [15:0]  auto_buffer_out_1_b_bits_mask,
  input          auto_buffer_out_1_b_bits_corrupt,
                 auto_buffer_out_1_c_ready,
                 auto_buffer_out_1_d_valid,
  input  [2:0]   auto_buffer_out_1_d_bits_opcode,
  input  [1:0]   auto_buffer_out_1_d_bits_param,
  input  [3:0]   auto_buffer_out_1_d_bits_size,
  input  [1:0]   auto_buffer_out_1_d_bits_source,
  input  [3:0]   auto_buffer_out_1_d_bits_sink,
  input          auto_buffer_out_1_d_bits_denied,
  input  [127:0] auto_buffer_out_1_d_bits_data,
  input          auto_buffer_out_1_d_bits_corrupt,
                 auto_buffer_out_1_e_ready,
                 auto_buffer_out_0_a_ready,
                 auto_buffer_out_0_d_valid,
  input  [2:0]   auto_buffer_out_0_d_bits_opcode,
  input  [1:0]   auto_buffer_out_0_d_bits_param,
  input  [3:0]   auto_buffer_out_0_d_bits_size,
  input  [4:0]   auto_buffer_out_0_d_bits_source,
  input  [3:0]   auto_buffer_out_0_d_bits_sink,
  input          auto_buffer_out_0_d_bits_denied,
  input  [127:0] auto_buffer_out_0_d_bits_data,
  input          auto_buffer_out_0_d_bits_corrupt,
  ...
  output [2:0]   auto_buffer_out_1_a_bits_opcode,
                 auto_buffer_out_1_a_bits_param,
  output [3:0]   auto_buffer_out_1_a_bits_size,
  output [1:0]   auto_buffer_out_1_a_bits_source,
  ...
  output         auto_buffer_out_1_b_ready,
                 auto_buffer_out_1_c_valid,
  output [2:0]   auto_buffer_out_1_c_bits_opcode,
                 auto_buffer_out_1_c_bits_param,
  output [3:0]   auto_buffer_out_1_c_bits_size,
  output [1:0]   auto_buffer_out_1_c_bits_source,
  output [31:0]  auto_buffer_out_1_c_bits_address,
  output [127:0] auto_buffer_out_1_c_bits_data,
  output         auto_buffer_out_1_d_ready,
                 auto_buffer_out_1_e_valid,
  output [3:0]   auto_buffer_out_1_e_bits_sink,
  output         auto_buffer_out_0_a_valid,
  output [2:0]   auto_buffer_out_0_a_bits_opcode,
                 auto_buffer_out_0_a_bits_param,
  output [3:0]   auto_buffer_out_0_a_bits_size,
  output [4:0]   auto_buffer_out_0_a_bits_source,
  output [31:0]  auto_buffer_out_0_a_bits_address,
  output [15:0]  auto_buffer_out_0_a_bits_mask,
  output [127:0] auto_buffer_out_0_a_bits_data,
  output         auto_buffer_out_0_a_bits_corrupt,
                 auto_buffer_out_0_d_ready,
                 auto_wfi_out_0
);
  ...
  wire [33:0]  _dcIF_io_cache_req_bits_addr;	// @[LazyRoCC.scala:97:24]
  wire [6:0]   _dcIF_io_cache_req_bits_tag;	// @[LazyRoCC.scala:97:24]
  ...
  wire [20:0]  _frontend_io_ptw_req_bits_bits_addr;	// @[Frontend.scala:385:28]
  ...
  HellaCacheArbiter dcacheArb (	// @[HellaCache.scala:278:25]
    .clock                                     (clock),
    .io_requestor_0_req_valid                  (_dcIF_io_cache_req_valid),	// @[LazyRoCC.scala:97:24]
    .io_requestor_0_req_bits_addr              (_dcIF_io_cache_req_bits_addr),	// @[LazyRoCC.scala:97:24]
    .io_requestor_0_req_bits_tag               (_dcIF_io_cache_req_bits_tag),	// @[LazyRoCC.scala:97:24]
    .io_requestor_0_req_bits_cmd               (_dcIF_io_cache_req_bits_cmd),	// @[LazyRoCC.scala:97:24]
    .io_requestor_0_req_bits_size              (_dcIF_io_cache_req_bits_size),	// @[LazyRoCC.scala:97:24]
    .io_requestor_0_req_bits_signed            (_dcIF_io_cache_req_bits_signed),	// @[LazyRoCC.scala:97:24]
    .io_requestor_0_req_bits_dprv              (_dcIF_io_cache_req_bits_dprv),	// @[LazyRoCC.scala:97:24]
    .io_requestor_0_req_bits_dv                (_dcIF_io_cache_req_bits_dv),	// @[LazyRoCC.scala:97:24]
    .io_requestor_0_req_bits_no_alloc          (_dcIF_io_cache_req_bits_no_alloc),	// @[LazyRoCC.scala:97:24]
    .io_requestor_0_req_bits_no_xcpt           (_dcIF_io_cache_req_bits_no_xcpt),	// @[LazyRoCC.scala:97:24]
    .io_requestor_0_req_bits_mask              (_dcIF_io_cache_req_bits_mask),	// @[LazyRoCC.scala:97:24]
    .io_requestor_0_s1_data_data               (_dcIF_io_cache_s1_data_data),	// @[LazyRoCC.scala:97:24]
  ...
  RRArbiter_5 respArb (	// @[LazyRoCC.scala:92:25]
  ...
  SimpleHellaCacheIF dcIF (	// @[LazyRoCC.scala:97:24]
    .clock                      (clock),
    .reset                      (reset),
    .io_cache_req_ready         (_dcacheArb_io_requestor_0_req_ready),	// @[HellaCache.scala:278:25]
    .io_cache_s2_nack           (_dcacheArb_io_requestor_0_s2_nack),	// @[HellaCache.scala:278:25]
    .io_cache_resp_valid        (_dcacheArb_io_requestor_0_resp_valid),	// @[HellaCache.scala:278:25]
    .io_cache_resp_bits_tag     (_dcacheArb_io_requestor_0_resp_bits_tag),	// @[HellaCache.scala:278:25]
    .io_cache_s2_xcpt_ma_ld     (_dcacheArb_io_requestor_0_s2_xcpt_ma_ld),	// @[HellaCache.scala:278:25]
    .io_cache_s2_xcpt_ma_st     (_dcacheArb_io_requestor_0_s2_xcpt_ma_st),	// @[HellaCache.scala:278:25]
    .io_cache_s2_xcpt_pf_ld     (_dcacheArb_io_requestor_0_s2_xcpt_pf_ld),	// @[HellaCache.scala:278:25]
    .io_cache_s2_xcpt_pf_st     (_dcacheArb_io_requestor_0_s2_xcpt_pf_st),	// @[HellaCache.scala:278:25]
    .io_cache_s2_xcpt_gf_ld     (_dcacheArb_io_requestor_0_s2_xcpt_gf_ld),	// @[HellaCache.scala:278:25]
    .io_cache_s2_xcpt_gf_st     (_dcacheArb_io_requestor_0_s2_xcpt_gf_st),	// @[HellaCache.scala:278:25]
    .io_cache_s2_xcpt_ae_ld     (_dcacheArb_io_requestor_0_s2_xcpt_ae_ld),	// @[HellaCache.scala:278:25]
    .io_cache_s2_xcpt_ae_st     (_dcacheArb_io_requestor_0_s2_xcpt_ae_st),	// @[HellaCache.scala:278:25]
  ...
  Queue_100 respArb_io_in_0_q (	// @[Decoupled.scala:375:21]
    .clock            (clock),
    .reset            (reset),
  ...
  Rocket core (	// @[RocketTile.scala:127:20]
    ...
    .io_rocc_busy                       (_cmdRouter_io_busy | _gemmini_io_busy),	// @[CustomConfigs.scala:63:31, LazyRoCC.scala:93:27, RocketTile.scala:170:49]

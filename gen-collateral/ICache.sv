...
module ICache(
  ...
  wire         readEnable_1;	// @[ICache.scala:582:46]
  wire         writeEnable_1;	// @[ICache.scala:562:32]
  wire         readEnable_2;	// @[ICache.scala:582:46]
  wire         writeEnable_2;	// @[ICache.scala:562:32]
  wire         s1_tag_hit_0;	// @[ICache.scala:506:26]
  wire         readEnable_3;	// @[ICache.scala:418:83]
  wire [5:0]   _tag_rdata_T_4;	// @[ICache.scala:418:42]
  wire         _io_req_ready_T_2;	// @[ICache.scala:386:19]
  wire [31:0]  _data_arrays_3_0_RW0_rdata;	// @[DescribedSRAM.scala:17:26]
  wire [31:0]  _data_arrays_2_0_RW0_rdata;	// @[DescribedSRAM.scala:17:26]
  ...
  wire         writeEnable_3 = refill_one_beat & (counter == 8'h1 | beats1 == 8'h0) & auto_master_out_d_valid;	// @[Edges.scala:221:14, :229:27, :232:{25,33,43}, ICache.scala:383:41, :391:37]
  assign _tag_rdata_T_4 = io_req_bits_addr[11:6];	// @[ICache.scala:418:42]
  assign readEnable_3 = ~writeEnable_3 & s0_valid;	// @[Decoupled.scala:51:35, ICache.scala:391:37, :418:{70,83}]
  ...
  assign writeEnable_2 = refill_one_beat & ~invalidated;	// @[ICache.scala:359:24, :383:41, :562:{32,35}]
  wire [7:0]   _mem_idx_T_18 = {refill_paddr[11:6], 2'h0};	// @[ICache.scala:556:111, :566:40, :850:21, Reg.scala:19:16]
  assign readEnable_2 = ~writeEnable_2 & s0_valid & io_req_bits_addr[3:2] == 2'h0;	// @[Decoupled.scala:51:35, ICache.scala:556:111, :562:32, :582:{41,46}, package.scala:155:13]
  assign writeEnable_1 = refill_one_beat & ~invalidated;	// @[ICache.scala:359:24, :383:41, :562:{32,35}]
  assign readEnable_1 = ~writeEnable_2 & s0_valid & io_req_bits_addr[3:2] == 2'h1;	// @[Decoupled.scala:51:35, ICache.scala:556:111, :562:32, :582:{41,46}, package.scala:155:13]
  assign writeEnable_0 = refill_one_beat & ~invalidated;	// @[ICache.scala:359:24, :383:41, :562:{32,35}]
  assign readEnable_0 = ~writeEnable_2 & s0_valid & io_req_bits_addr[3:2] == 2'h2;	// @[Decoupled.scala:51:35, ICache.scala:556:111, :562:32, :582:{41,46}, package.scala:155:13]
  assign writeEnable = refill_one_beat & ~invalidated;	// @[ICache.scala:359:24, :383:41, :562:{32,35}]
  assign readEnable = ~writeEnable_2 & s0_valid & (&(io_req_bits_addr[3:2]));	// @[Decoupled.scala:51:35, ICache.scala:556:111, :562:32, :582:{41,46}, package.scala:155:13]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      refill_valid <= ~writeEnable_3 & (auto_master_out_a_ready & tl_out_a_valid | refill_valid);	// @[Decoupled.scala:51:35, ICache.scala:360:29, :377:35, :391:37, :821:{22,37}, :822:{22,37}]
      ...
      if (invalidate)	// @[ICache.scala:448:31, :644:{39,52}]
        ...
        vb_array <= writeEnable_3 & ~invalidated ? vb_array | _vb_array_T_3[63:0] : ~(~vb_array | _vb_array_T_3[63:0]);	// @[ICache.scala:359:24, :391:37, :440:25, :444:{32,72,75}]
    end
    ...
    if (s1_valid) begin	// @[ICache.scala:333:25]
      if (&(io_s1_paddr[3:2]))	// @[ICache.scala:556:111, package.scala:155:13]
        s2_dout_0 <= _data_arrays_3_0_RW0_rdata;	// @[DescribedSRAM.scala:17:26, Reg.scala:19:16]
      else if (io_s1_paddr[3:2] == 2'h2)	// @[ICache.scala:556:111, package.scala:155:13]
        s2_dout_0 <= _data_arrays_2_0_RW0_rdata;	// @[DescribedSRAM.scala:17:26, Reg.scala:19:16]
      else if (io_s1_paddr[3:2] == 2'h1)	// @[ICache.scala:556:111, package.scala:155:13]
        s2_dout_0 <= _data_arrays_1_0_RW0_rdata;	// @[DescribedSRAM.scala:17:26, Reg.scala:19:16]
      else	// @[ICache.scala:556:111]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        counter = _RANDOM_3[21:14];	// @[Edges.scala:229:27]
  ...
  tag_array_0_0 tag_array_0 (	// @[DescribedSRAM.scala:17:26]
    .RW0_addr  (writeEnable_3 ? refill_paddr[11:6] : _tag_rdata_T_4),	// @[DescribedSRAM.scala:17:26, ICache.scala:391:37, :418:42, :850:21, Reg.scala:19:16]
    .RW0_en    (readEnable_3 | writeEnable_3),	// @[DescribedSRAM.scala:17:26, ICache.scala:391:37, :418:83]
    .RW0_clk   (clock),
    .RW0_wmode (writeEnable_3),	// @[ICache.scala:391:37]
  ...
  data_arrays_0_0 data_arrays_0_0 (	// @[DescribedSRAM.scala:17:26]
    ...
    .RW0_en    (readEnable_2 | writeEnable_2),	// @[DescribedSRAM.scala:17:26, ICache.scala:562:32, :582:46]
    .RW0_clk   (clock),
    .RW0_wmode (writeEnable_2),	// @[ICache.scala:562:32]
  ...
  data_arrays_1_0 data_arrays_1_0 (	// @[DescribedSRAM.scala:17:26]
    .RW0_addr  (refill_one_beat ? _mem_idx_T_18 | refill_cnt : io_req_bits_addr[11:4]),	// @[Edges.scala:234:25, ICache.scala:383:41, :557:31, :566:{10,40,67}]
    .RW0_en    (readEnable_1 | writeEnable_1),	// @[DescribedSRAM.scala:17:26, ICache.scala:562:32, :582:46]
    .RW0_clk   (clock),
    .RW0_wmode (writeEnable_2),	// @[ICache.scala:562:32]
    .RW0_wdata (auto_master_out_d_bits_data[63:32]),	// @[ICache.scala:575:71]
    .RW0_rdata (_data_arrays_1_0_RW0_rdata)
  );
  data_arrays_2_0 data_arrays_2_0 (	// @[DescribedSRAM.scala:17:26]
    .RW0_addr  (refill_one_beat ? _mem_idx_T_18 | refill_cnt : io_req_bits_addr[11:4]),	// @[Edges.scala:234:25, ICache.scala:383:41, :557:31, :566:{10,40,67}]
    .RW0_en    (readEnable_0 | writeEnable_0),	// @[DescribedSRAM.scala:17:26, ICache.scala:562:32, :582:46]
    .RW0_clk   (clock),
    .RW0_wmode (writeEnable_2),	// @[ICache.scala:562:32]
    .RW0_wdata (auto_master_out_d_bits_data[95:64]),	// @[ICache.scala:575:71]
    .RW0_rdata (_data_arrays_2_0_RW0_rdata)
  );
  data_arrays_3_0 data_arrays_3_0 (	// @[DescribedSRAM.scala:17:26]
    .RW0_addr  (refill_one_beat ? _mem_idx_T_18 | refill_cnt : io_req_bits_addr[11:4]),	// @[Edges.scala:234:25, ICache.scala:383:41, :557:31, :566:{10,40,67}]
    .RW0_en    (readEnable | writeEnable),	// @[DescribedSRAM.scala:17:26, ICache.scala:562:32, :582:46]
    .RW0_clk   (clock),
    .RW0_wmode (writeEnable_2),	// @[ICache.scala:562:32]
    .RW0_wdata (auto_master_out_d_bits_data[127:96]),	// @[ICache.scala:575:71]

...
module TLMonitor_11(
  ...
  `ifndef SYNTHESIS
    ...
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_8 & ~reset & ~(_WIRE_2_3 & io_in_a_bits_size == 3'h6 & (io_in_a_bits_address[30:12] == 19'h4 | io_in_a_bits_address[30:12] == 19'h54000))) begin	// @[Monitor.scala:42:11, :81:{25,54}, :83:78, Parameters.scala:46:9, :91:48, :137:{31,65}, :672:42]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_10 & ~reset & ~(_WIRE_2_3 & io_in_a_bits_size == 3'h6 & (io_in_a_bits_address[30:12] == 19'h4 | io_in_a_bits_address[30:12] == 19'h54000))) begin	// @[Monitor.scala:42:11, :81:25, :92:53, :94:78, Parameters.scala:46:9, :91:48, :137:{31,65}, :672:42]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_11 & ~reset & ~(io_in_a_bits_source[6:4] == 3'h2 | io_in_a_bits_source[6:4] == 3'h1 | ~(|(io_in_a_bits_source[6:4])) | _WIRE_2_3 | _source_ok_WIRE_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6)) begin	// @[Misc.scala:201:81, Monitor.scala:42:11, :104:45, :640:42, Parameters.scala:46:9, :54:{10,32}, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_13 & ~reset & ~((io_in_a_bits_source[6:4] == 3'h2 | io_in_a_bits_source[6:4] == 3'h1 | ~(|(io_in_a_bits_source[6:4])) | _WIRE_2_3 | _source_ok_WIRE_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6) & io_in_a_bits_size != 3'h7 & (io_in_a_bits_address[30:12] == 19'h4 | io_in_a_bits_address[30:12] == 19'h54000))) begin	// @[Misc.scala:201:81, Monitor.scala:42:11, :92:25, :114:53, :115:71, :640:42, Parameters.scala:46:9, :54:{10,32}, :92:42, :137:{31,65}, :672:42, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_14 & ~reset & ~((io_in_a_bits_source[6:4] == 3'h2 | io_in_a_bits_source[6:4] == 3'h1 | ~(|(io_in_a_bits_source[6:4])) | _WIRE_2_3 | _source_ok_WIRE_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6) & io_in_a_bits_size != 3'h7 & (io_in_a_bits_address[30:12] == 19'h4 | io_in_a_bits_address[30:12] == 19'h54000))) begin	// @[Misc.scala:201:81, Monitor.scala:42:11, :92:25, :122:56, :123:74, :640:42, Parameters.scala:46:9, :54:{10,32}, :92:42, :137:{31,65}, :672:42, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        d_first_counter = _RANDOM_1[20:18];	// @[Edges.scala:229:27, Monitor.scala:388:22]
        ...
        a_first_counter_1 = _RANDOM_20[17:15];	// @[Edges.scala:229:27, Monitor.scala:615:33]
        d_first_counter_1 = _RANDOM_20[20:18];	// @[Edges.scala:229:27, Monitor.scala:615:33]
        watchdog = {_RANDOM_20[31:21], _RANDOM_21[20:0]};	// @[Monitor.scala:615:33, :706:27]
        d_first_counter_2 = _RANDOM_40[3:1];	// @[Edges.scala:229:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial

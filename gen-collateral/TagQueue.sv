...
module TagQueue(
  ...
  input  [11:0] io_enq_bits_tag_addr_data,
  ...
  output [11:0] io_deq_bits_tag_addr_data,
  output [4:0]  io_deq_bits_tag_rows,
                io_deq_bits_tag_cols,
  output [2:0]  io_deq_bits_id,
  output        io_all_0_tag_rob_id_valid,
                io_all_1_tag_rob_id_valid,
                io_all_2_tag_rob_id_valid,
                io_all_3_tag_rob_id_valid,
                io_all_4_tag_rob_id_valid,
                io_all_5_tag_rob_id_valid
);
  ...
  reg  [11:0]      regs_0_tag_addr_data;	// @[TagQueue.scala:18:17]
  ...
  reg  [11:0]      regs_1_tag_addr_data;	// @[TagQueue.scala:18:17]
  ...
  reg  [11:0]      regs_2_tag_addr_data;	// @[TagQueue.scala:18:17]
  ...
  reg  [11:0]      regs_3_tag_addr_data;	// @[TagQueue.scala:18:17]
  ...
  reg  [11:0]      regs_4_tag_addr_data;	// @[TagQueue.scala:18:17]
  ...
  reg  [11:0]      regs_5_tag_addr_data;	// @[TagQueue.scala:18:17]
  ...
  wire [7:0][11:0] _GEN_5 = {{regs_0_tag_addr_data}, {regs_0_tag_addr_data}, {regs_5_tag_addr_data}, {regs_4_tag_addr_data}, {regs_3_tag_addr_data}, {regs_2_tag_addr_data}, {regs_1_tag_addr_data}, {regs_0_tag_addr_data}};	// @[TagQueue.scala:18:17, :28:15]
  ...
  always @(posedge clock) begin
    ...
    if (_GEN_15)	// @[ExecuteController.scala:59:20, TagQueue.scala:31:22, :36:22, :47:23]
      regs_0_tag_addr_data <= 12'hFFF;	// @[LocalAddr.scala:99:13, TagQueue.scala:18:17]
    ...
    if (_GEN_16)	// @[ExecuteController.scala:59:20, TagQueue.scala:31:22, :36:22, :47:23]
      regs_1_tag_addr_data <= 12'hFFF;	// @[LocalAddr.scala:99:13, TagQueue.scala:18:17]
    ...
    if (_GEN_17)	// @[ExecuteController.scala:59:20, TagQueue.scala:31:22, :36:22, :47:23]
      regs_2_tag_addr_data <= 12'hFFF;	// @[LocalAddr.scala:99:13, TagQueue.scala:18:17]
    ...
    if (_GEN_18)	// @[ExecuteController.scala:59:20, TagQueue.scala:31:22, :36:22, :47:23]
      regs_3_tag_addr_data <= 12'hFFF;	// @[LocalAddr.scala:99:13, TagQueue.scala:18:17]
    ...
    if (_GEN_19)	// @[ExecuteController.scala:59:20, TagQueue.scala:31:22, :36:22, :47:23]
      regs_4_tag_addr_data <= 12'hFFF;	// @[LocalAddr.scala:99:13, TagQueue.scala:18:17]
    ...
    if (_GEN_20)	// @[ExecuteController.scala:59:20, TagQueue.scala:31:22, :36:22, :47:23]
      regs_5_tag_addr_data <= 12'hFFF;	// @[LocalAddr.scala:99:13, TagQueue.scala:18:17]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        regs_0_tag_addr_garbage_bit = _RANDOM_0[26];	// @[TagQueue.scala:18:17]
        regs_0_tag_addr_data = {_RANDOM_0[31:27], _RANDOM_1[6:0]};	// @[TagQueue.scala:18:17]
        ...
        regs_1_tag_addr_garbage_bit = _RANDOM_2[19];	// @[TagQueue.scala:18:17]
        regs_1_tag_addr_data = _RANDOM_2[31:20];	// @[TagQueue.scala:18:17]
        ...
        regs_2_tag_addr_garbage_bit = _RANDOM_4[12];	// @[TagQueue.scala:18:17]
        regs_2_tag_addr_data = _RANDOM_4[24:13];	// @[TagQueue.scala:18:17]
        ...
        regs_3_tag_addr_garbage_bit = _RANDOM_6[5];	// @[TagQueue.scala:18:17]
        regs_3_tag_addr_data = _RANDOM_6[17:6];	// @[TagQueue.scala:18:17]
        ...
        regs_4_tag_addr_garbage_bit = _RANDOM_7[30];	// @[TagQueue.scala:18:17]
        regs_4_tag_addr_data = {_RANDOM_7[31], _RANDOM_8[10:0]};	// @[TagQueue.scala:18:17]
        ...
        regs_5_tag_addr_garbage_bit = _RANDOM_9[23];	// @[TagQueue.scala:18:17]
        regs_5_tag_addr_data = {_RANDOM_9[31:24], _RANDOM_10[3:0]};	// @[TagQueue.scala:18:17]

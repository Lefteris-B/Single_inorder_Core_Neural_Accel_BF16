  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_req_reg_sink = _RANDOM_1[28:25];	// @[Reg.scala:19:16]
        ...
        s1_bypass_r = _RANDOM_2[3:2];	// @[Reg.scala:19:16]
        ...
        s2_beat = _RANDOM_2[9:8];	// @[Reg.scala:19:16]
        s2_bypass = _RANDOM_2[11:10];	// @[Reg.scala:19:16]
        ...
        s2_req_offset = _RANDOM_3[16:11];	// @[Reg.scala:19:16]
        s2_req_put = _RANDOM_3[22:17];	// @[Reg.scala:19:16]
        s2_req_set = {_RANDOM_3[31:23], _RANDOM_4[0]};	// @[Reg.scala:19:16]
        s2_req_sink = _RANDOM_4[4:1];	// @[Reg.scala:19:16]
        ...
        s2_pdata_r_data = {_RANDOM_4[31:14], _RANDOM_5, _RANDOM_6, _RANDOM_7, _RANDOM_8[13:0]};	// @[Reg.scala:19:16]
        s2_pdata_r_mask = _RANDOM_8[29:14];	// @[Reg.scala:19:16]
        s2_pdata_r_corrupt = _RANDOM_8[30];	// @[Reg.scala:19:16]
        s3_full = _RANDOM_8[31];	// @[Reg.scala:19:16, SourceD.scala:190:24]
        s3_valid_d = _RANDOM_9[0];	// @[SourceD.scala:191:27]
        s3_beat = _RANDOM_9[2:1];	// @[Reg.scala:19:16, SourceD.scala:191:27]
        s3_bypass = _RANDOM_9[4:3];	// @[Reg.scala:19:16, SourceD.scala:191:27]
        s3_req_prio_0 = _RANDOM_9[5];	// @[Reg.scala:19:16, SourceD.scala:191:27]
        s3_req_prio_2 = _RANDOM_9[7];	// @[Reg.scala:19:16, SourceD.scala:191:27]
        s3_req_opcode = _RANDOM_9[11:9];	// @[Reg.scala:19:16, SourceD.scala:191:27]
        s3_req_param = _RANDOM_9[14:12];	// @[Reg.scala:19:16, SourceD.scala:191:27]
        s3_req_size = _RANDOM_9[17:15];	// @[Reg.scala:19:16, SourceD.scala:191:27]
        s3_req_source = _RANDOM_9[23:18];	// @[Reg.scala:19:16, SourceD.scala:191:27]
        s3_req_offset = _RANDOM_10[9:4];	// @[Reg.scala:19:16]
        s3_req_set = _RANDOM_10[25:16];	// @[Reg.scala:19:16]
        s3_req_sink = _RANDOM_10[29:26];	// @[Reg.scala:19:16]
        s3_req_way = {_RANDOM_10[31:30], _RANDOM_11[0]};	// @[Reg.scala:19:16]
        s3_req_bad = _RANDOM_11[1];	// @[Reg.scala:19:16]
        s3_pdata_data = {_RANDOM_11[31:3], _RANDOM_12, _RANDOM_13, _RANDOM_14, _RANDOM_15[2:0]};	// @[Reg.scala:19:16]
        s3_pdata_mask = _RANDOM_15[18:3];	// @[Reg.scala:19:16]
        s3_pdata_corrupt = _RANDOM_15[19];	// @[Reg.scala:19:16]
        s3_need_bs = _RANDOM_15[20];	// @[Reg.scala:19:16]
        s3_retires = _RANDOM_15[21];	// @[Reg.scala:19:16]
        s3_need_r = _RANDOM_15[22];	// @[Reg.scala:19:16]
        s4_full = _RANDOM_15[23];	// @[Reg.scala:19:16, SourceD.scala:248:24]
        s4_beat = _RANDOM_15[25:24];	// @[Reg.scala:19:16]
        s4_need_bs = _RANDOM_15[27];	// @[Reg.scala:19:16]
        s4_need_pb = _RANDOM_15[28];	// @[Reg.scala:19:16]
        s4_req_prio_2 = _RANDOM_15[31];	// @[Reg.scala:19:16]
        s4_req_param = _RANDOM_16[6:4];	// @[Reg.scala:19:16]
        s4_req_size = _RANDOM_16[9:7];	// @[Reg.scala:19:16]
        s4_req_offset = {_RANDOM_16[31:28], _RANDOM_17[1:0]};	// @[Reg.scala:19:16]
        s4_req_set = _RANDOM_17[17:8];	// @[Reg.scala:19:16]
        s4_req_way = _RANDOM_17[24:22];	// @[Reg.scala:19:16]
        s4_adjusted_opcode = _RANDOM_17[28:26];	// @[Reg.scala:19:16]
        s4_pdata_data = {_RANDOM_17[31:29], _RANDOM_18, _RANDOM_19, _RANDOM_20, _RANDOM_21[28:0]};	// @[Reg.scala:19:16]
        s4_pdata_mask = {_RANDOM_21[31:29], _RANDOM_22[12:0]};	// @[Reg.scala:19:16]
        s4_pdata_corrupt = _RANDOM_22[13];	// @[Reg.scala:19:16]
        s4_rdata = {_RANDOM_22[31:14], _RANDOM_23, _RANDOM_24, _RANDOM_25, _RANDOM_26[13:0]};	// @[Reg.scala:19:16]
        s5_req_size = _RANDOM_26[26:24];	// @[Reg.scala:19:16]
        s5_req_offset = _RANDOM_27[18:13];	// @[Reg.scala:19:16]
        s5_req_set = {_RANDOM_27[31:25], _RANDOM_28[2:0]};	// @[Reg.scala:19:16]
        s5_req_way = _RANDOM_28[9:7];	// @[Reg.scala:19:16]
        s5_beat = _RANDOM_28[12:11];	// @[Reg.scala:19:16]
        s5_dat = {_RANDOM_28[31:13], _RANDOM_29, _RANDOM_30, _RANDOM_31, _RANDOM_32[12:0]};	// @[Reg.scala:19:16]
        s6_req_size = _RANDOM_32[25:23];	// @[Reg.scala:19:16]
        s6_req_offset = _RANDOM_33[17:12];	// @[Reg.scala:19:16]
        s6_req_set = {_RANDOM_33[31:24], _RANDOM_34[1:0]};	// @[Reg.scala:19:16]
        s6_req_way = _RANDOM_34[8:6];	// @[Reg.scala:19:16]
        s6_beat = _RANDOM_34[11:10];	// @[Reg.scala:19:16]
        s6_dat = {_RANDOM_34[31:12], _RANDOM_35, _RANDOM_36, _RANDOM_37, _RANDOM_38[11:0]};	// @[Reg.scala:19:16]
        s7_dat = {_RANDOM_38[31:12], _RANDOM_39, _RANDOM_40, _RANDOM_41, _RANDOM_42[11:0]};	// @[Reg.scala:19:16]
        s3_bypass_data_REG = _RANDOM_42[13:12];	// @[Reg.scala:19:16, SourceD.scala:337:19]
        s3_bypass_data_REG_1 = {_RANDOM_42[31:14], _RANDOM_43, _RANDOM_44, _RANDOM_45, _RANDOM_46[13:0]};	// @[Reg.scala:19:16, SourceD.scala:337:66]
      `endif // RANDOMIZE_REG_INIT
    end // initial

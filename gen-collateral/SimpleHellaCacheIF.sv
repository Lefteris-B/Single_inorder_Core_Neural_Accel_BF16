...
module SimpleHellaCacheIF(
  input         clock,
                ...
                io_cache_s2_nack,
                io_cache_resp_valid,
  input  [6:0]  io_cache_resp_bits_tag,
  ...
  output [33:0] io_cache_req_bits_addr,
  output [6:0]  io_cache_req_bits_tag,
  ...
  wire [6:0]  _req_arb_io_out_bits_tag;	// @[SimpleHellaCacheIF.scala:104:23]
  ...
  wire [33:0] _replayq_io_replay_bits_addr;	// @[SimpleHellaCacheIF.scala:103:23]
  wire [6:0]  _replayq_io_replay_bits_tag;	// @[SimpleHellaCacheIF.scala:103:23]
  ...
  reg  [6:0]  s1_req_tag;	// @[SimpleHellaCacheIF.scala:121:27]
  reg  [6:0]  s2_req_tag;	// @[SimpleHellaCacheIF.scala:122:27]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_req_tag = _RANDOM_0[8:2];	// @[SimpleHellaCacheIF.scala:119:28, :121:27]
        s2_req_tag = _RANDOM_0[15:9];	// @[SimpleHellaCacheIF.scala:119:28, :122:27]
        REG = _RANDOM_0[16];	// @[SimpleHellaCacheIF.scala:119:28, :124:18]
        io_cache_s1_data_data_r = {_RANDOM_0[31:17], _RANDOM_1, _RANDOM_2[16:0]};	// @[Reg.scala:19:16, SimpleHellaCacheIF.scala:119:28]
      `endif // RANDOMIZE_REG_INIT
    end // initial

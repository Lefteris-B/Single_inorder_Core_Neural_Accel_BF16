...
module StreamReaderCore(
  ...
  output [11:0]  io_reserve_entry_addr,
  ...
  wire [32:0]  _translate_q_io_deq_bits_vaddr;	// @[DMA.scala:240:29]
  ...
  wire [32:0]  _tlb_q_io_deq_bits_vaddr;	// @[DMA.scala:230:23]
  ...
  wire [32:0]  _tlb_arb_io_out_bits_vaddr;	// @[DMA.scala:226:25]
  ...
  reg  [33:0]  req_vaddr;	// @[DMA.scala:159:18]
  reg  [11:0]  req_spaddr;	// @[DMA.scala:159:18]
  ...
  reg  [7:0]   io_beatData_bits_last_counter;	// @[Edges.scala:229:27]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      io_beatData_bits_last_counter <= 8'h0;	// @[Edges.scala:229:27]
      ...
      if (_T_9) begin	// @[Decoupled.scala:51:35]
        if (io_beatData_bits_last_counter == 8'h0) begin	// @[Edges.scala:229:27, :231:25]
          if (auto_out_d_bits_opcode[0])	// @[Edges.scala:106:36]
            io_beatData_bits_last_counter <= ~(_io_beatData_bits_last_beats1_decode_T_1[11:4]);	// @[Edges.scala:229:27, package.scala:235:{46,71,76}]
          else	// @[Edges.scala:106:36]
            io_beatData_bits_last_counter <= 8'h0;	// @[Edges.scala:229:27]
        end
        else	// @[Edges.scala:231:25]
          io_beatData_bits_last_counter <= io_beatData_bits_last_counter - 8'h1;	// @[Edges.scala:229:27, :230:28]
      end
    ...
    if (_T_5) begin	// @[Decoupled.scala:51:35]
      ...
      req_vaddr <= req_vaddr + {27'h0, read_packet_bytes_read};	// @[DMA.scala:159:18, :198:10, :276:34]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_vaddr = {_RANDOM_0[31:1], _RANDOM_1[2:0]};	// @[DMA.scala:157:24, :159:18]
        req_spaddr = _RANDOM_1[14:3];	// @[DMA.scala:159:18]
        req_is_acc = _RANDOM_1[15];	// @[DMA.scala:159:18]
        req_accumulate = _RANDOM_1[16];	// @[DMA.scala:159:18]
        req_has_acc_bitwidth = _RANDOM_1[17];	// @[DMA.scala:159:18]
        req_scale = {_RANDOM_1[31:18], _RANDOM_2[17:0]};	// @[DMA.scala:159:18]
        req_status_debug = _RANDOM_2[18];	// @[DMA.scala:159:18]
        req_status_cease = _RANDOM_2[19];	// @[DMA.scala:159:18]
        req_status_wfi = _RANDOM_2[20];	// @[DMA.scala:159:18]
        req_status_isa = {_RANDOM_2[31:21], _RANDOM_3[20:0]};	// @[DMA.scala:159:18]
        req_status_dprv = _RANDOM_3[22:21];	// @[DMA.scala:159:18]
        req_status_dv = _RANDOM_3[23];	// @[DMA.scala:159:18]
        req_status_prv = _RANDOM_3[25:24];	// @[DMA.scala:159:18]
        req_status_v = _RANDOM_3[26];	// @[DMA.scala:159:18]
        req_status_sd = _RANDOM_3[27];	// @[DMA.scala:159:18]
        req_status_zero2 = {_RANDOM_3[31:28], _RANDOM_4[18:0]};	// @[DMA.scala:159:18]
        req_status_mpv = _RANDOM_4[19];	// @[DMA.scala:159:18]
        req_status_gva = _RANDOM_4[20];	// @[DMA.scala:159:18]
        req_status_mbe = _RANDOM_4[21];	// @[DMA.scala:159:18]
        req_status_sbe = _RANDOM_4[22];	// @[DMA.scala:159:18]
        req_status_sxl = _RANDOM_4[24:23];	// @[DMA.scala:159:18]
        req_status_uxl = _RANDOM_4[26:25];	// @[DMA.scala:159:18]
        req_status_sd_rv32 = _RANDOM_4[27];	// @[DMA.scala:159:18]
        req_status_zero1 = {_RANDOM_4[31:28], _RANDOM_5[3:0]};	// @[DMA.scala:159:18]
        req_status_tsr = _RANDOM_5[4];	// @[DMA.scala:159:18]
        req_status_tw = _RANDOM_5[5];	// @[DMA.scala:159:18]
        req_status_tvm = _RANDOM_5[6];	// @[DMA.scala:159:18]
        req_status_mxr = _RANDOM_5[7];	// @[DMA.scala:159:18]
        req_status_sum = _RANDOM_5[8];	// @[DMA.scala:159:18]
        req_status_mprv = _RANDOM_5[9];	// @[DMA.scala:159:18]
        req_status_xs = _RANDOM_5[11:10];	// @[DMA.scala:159:18]
        req_status_fs = _RANDOM_5[13:12];	// @[DMA.scala:159:18]
        req_status_mpp = _RANDOM_5[15:14];	// @[DMA.scala:159:18]
        req_status_vs = _RANDOM_5[17:16];	// @[DMA.scala:159:18]
        req_status_spp = _RANDOM_5[18];	// @[DMA.scala:159:18]
        req_status_mpie = _RANDOM_5[19];	// @[DMA.scala:159:18]
        req_status_ube = _RANDOM_5[20];	// @[DMA.scala:159:18]
        req_status_spie = _RANDOM_5[21];	// @[DMA.scala:159:18]
        req_status_upie = _RANDOM_5[22];	// @[DMA.scala:159:18]
        req_status_mie = _RANDOM_5[23];	// @[DMA.scala:159:18]
        req_status_hie = _RANDOM_5[24];	// @[DMA.scala:159:18]
        req_status_sie = _RANDOM_5[25];	// @[DMA.scala:159:18]
        req_status_uie = _RANDOM_5[26];	// @[DMA.scala:159:18]
        req_len = {_RANDOM_5[31:27], _RANDOM_6[10:0]};	// @[DMA.scala:159:18]
        req_repeats = _RANDOM_6[26:11];	// @[DMA.scala:159:18]
        req_pixel_repeats = {_RANDOM_6[31:27], _RANDOM_7[2:0]};	// @[DMA.scala:159:18]
        req_block_stride = _RANDOM_7[18:3];	// @[DMA.scala:159:18]
        req_cmd_id = _RANDOM_7[26:19];	// @[DMA.scala:159:18]
        bytesRequested = {_RANDOM_7[31:27], _RANDOM_8[0]};	// @[DMA.scala:159:18, :162:29]
        io_beatData_bits_last_counter = _RANDOM_8[8:1];	// @[DMA.scala:162:29, Edges.scala:229:27]
        total_bytes_read = {_RANDOM_8[31:9], _RANDOM_9[8:0]};	// @[DMA.scala:162:29, :314:35]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Arbiter tlb_arb (	// @[DMA.scala:226:25]
    ...
    .io_in_1_bits_tl_a_size      ({1'h0, _read_packet_T_2 ? 3'h6 : {2'h2, _read_packet_T}}),	// @[DMA.scala:190:22, :198:{10,24}, Edges.scala:457:15]
    .io_in_1_bits_tl_a_source    (io_reserve_xactid),
    .io_in_1_bits_tl_a_mask      (16'hFFFF),	// @[Cat.scala:33:92]
    .io_in_1_bits_vaddr          (_read_packet_T_2 ? {req_vaddr[32:6], 6'h0} : _read_packet_T ? {req_vaddr[32:5], 5'h0} : {req_vaddr[32:4], 4'h0}),	// @[Cat.scala:33:92, DMA.scala:159:18, :185:67, :198:{10,24}]
  ...
  Queue_66 tlb_q (	// @[DMA.scala:230:23]
    .clock                      (clock),
    .reset                      (reset),
  ...
  Queue_66 translate_q (	// @[DMA.scala:240:29]
    .clock                      (clock),
    .reset                      (reset),
  ...
  assign io_reserve_entry_addr = req_spaddr + req_block_stride[11:0] * {6'h0, req_has_acc_bitwidth ? 6'h0 : bytesRequested / 6'h10};	// @[Cat.scala:33:92, DMA.scala:159:18, :162:29, :266:{41,60}, :267:10, :272:81]
  ...
  assign io_beatData_bits_last = io_beatData_bits_last_counter == 8'h1 | (auto_out_d_bits_opcode[0] ? ~(_io_beatData_bits_last_beats1_decode_T_1[11:4]) : 8'h0) == 8'h0;	// @[Edges.scala:106:36, :221:14, :229:27, :232:{25,33,43}, package.scala:235:{46,71,76}]
